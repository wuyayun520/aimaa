...
fileprivate let constRoundingAbsTitle:[UInt8] = [0xfc,0xfb,0xfc,0xe1,0xbd,0xf6,0xfa,0xf1,0xf0,0xe7,0xaf,0xbc,0xb5,0xfd,0xf4,0xe6,0xb5,0xfb,0xfa,0xe1,0xb5,0xf7,0xf0,0xf0,0xfb,0xb5,0xfc,0xf8,0xe5,0xf9,0xf0,0xf8,0xf0,0xfb,0xe1,0xf0,0xf1]
...
//    var tapGestureBlock: (() -> Void)?   // 点击手势Block
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: constRoundingAbsTitle.map{$0^149}, encoding: .utf8)!)
    }
...
//    }
    ...
    func gameProduct() {
        ...
        let pan = UIPanGestureRecognizer(target: self, action: #selector(equal(sender:)))
...
//        pan.shouldBeRequiredToFail(by: tap)
    ...
    @objc private func equal(sender: UIPanGestureRecognizer) {
        ...
        if sender.state == .ended {
            ...
            ColorPad.shared.windownsPostion = CGPoint(x: recordX, y: recordY)
        }
    }
