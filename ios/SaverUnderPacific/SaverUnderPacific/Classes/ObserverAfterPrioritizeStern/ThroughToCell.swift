...
/*: "#777777" :*/
fileprivate let show_banFormat:String = "#pricepricepriceprice"
fileprivate let show_minimizeFormat:String = "77"

/*: "#333333" :*/
fileprivate let main_adFormat:[Character] = ["#","3","3","3","3"]
fileprivate let dataGestureDoingceData:String = "speakerspeaker"

/*: "Followers" :*/
fileprivate let user_alwaysStr:String = "center form inputFollower"
fileprivate let constOntoData:[Character] = ["s"]

/*: "Following" :*/
fileprivate let showHundredWrittenData:[Character] = ["F","o","l","l","o","w","i","n","g"]

/*: "nav_back_black_nor" :*/
fileprivate let app_equalTradeValue:[Character] = ["n","a","v","_","b","a","c","k","_","b","l","a","c","k","_","n","o","r"]
...
class ThroughToCell: EasyChainSensor {
    //: var currentIndex = 0
    var currentIndex = 0
...
//        segmentedDataSource.itemSpacing = 0
        ...
        segmentedDataSource.titleNormalColor = UIColor(hex: (show_banFormat.replacingOccurrences(of: "price", with: "7") + show_minimizeFormat.capitalized))!
        //: segmentedDataSource.titleSelectedColor = UIColor.init(hex: "#333333")!
        segmentedDataSource.titleSelectedColor = UIColor(hex: (String(main_adFormat) + dataGestureDoingceData.replacingOccurrences(of: "speaker", with: "3")))!
        ...
        indicator.indicatorColor = UIColor(hex: (String(main_adFormat) + dataGestureDoingceData.replacingOccurrences(of: "speaker", with: "3")))!
    ...
    private lazy var titleArray: [String] = //: return ["Followers".localized, "Following".localized]
        [(String(user_alwaysStr.suffix(8)) + String(constOntoData)).localized, (String(showHundredWrittenData)).localized]
    //: }()

    //: private lazy var dataVC: [TalkingBaseViewController] = {
    private lazy var dataVC: [EasyChainSensor] = //: return [ArchitectureNameureViewController(), ReceiveQuery()]
        [ArchitectureNameureViewController(), ReceiveQuery()]
    //: }()
    ...
    private lazy var backButton: UIButton = {
        ...
        let img = UIImage.managerToSecond(name: (String(app_equalTradeValue))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .black
        btn.tintColor = .black
        //: btn.addTarget(self, action: #selector(backButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(propertyAcross), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension ThroughToCell: JXSegmentedViewDelegate {
...
extension ThroughToCell: JXPagingViewDelegate {
...
extension ThroughToCell {
    /// 返回按钮事件
    //: @objc private func backButtonClick() {
    @objc private func propertyAcross() {
