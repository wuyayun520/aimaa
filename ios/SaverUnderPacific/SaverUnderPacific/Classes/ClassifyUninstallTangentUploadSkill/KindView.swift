...
class KindView: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        rollLayer(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        rollLayer(placeholder: nil, placeholderColor: nil)
    }
}
...
extension KindView {
    ...
    private func rollLayer(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(LayerLocation().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(LayerLocation().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-LayerLocation().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: SubstantialVisible().top, left: SubstantialVisible().left, bottom: SubstantialVisible().bottom, right: SubstantialVisible().right)
...
extension KindView: UITextViewDelegate {
