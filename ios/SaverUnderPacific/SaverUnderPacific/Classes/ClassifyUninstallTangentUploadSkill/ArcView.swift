...
fileprivate let main_reasonMultipleData:[UInt8] = [0xd5,0xd2,0xd5,0xc8,0x94,0xdf,0xd3,0xd8,0xd9,0xce,0x86,0x95,0x9c,0xd4,0xdd,0xcf,0x9c,0xd2,0xd3,0xc8,0x9c,0xde,0xd9,0xd9,0xd2,0x9c,0xd5,0xd1,0xcc,0xd0,0xd9,0xd1,0xd9,0xd2,0xc8,0xd9,0xd8]

private func segmentUnderly(transform num: UInt8) -> UInt8 {
    return num ^ 188
}
...
class ArcView: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: main_reasonMultipleData.map{segmentUnderly(transform: $0)}, encoding: .utf8)!)
    }
