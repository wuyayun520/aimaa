...
@objcMembers open class InputCloseInfo: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = InputCloseInfo()
    //: private(set) var currLanguage: String = MovementStructure.getSystemLangCode()
    private(set) var currLanguage: String = MovementStructure.readyMerge()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func respectiveReady(_ language: String) {
...
extension String {
    ...
    public func theAppear(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let language = InputCloseInfo.shared.currLanguage
        //: let languageFolder = SVGAEffectTool.default.languagePath
        let languageFolder = UniqueProcessing.default.languagePath
