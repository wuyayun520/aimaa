...
/*: "&sr=6" :*/
fileprivate let showPhoneStr:String = "&sr=6testimony event"
...
enum HideInstead: String, CaseIterable {
...
class FrameScaleException: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func fillBy(urlType: MessageJob) -> String {
        //: var url = MarginExamineer.share.appConfigMode.urlH5Domain
        var url = MarginExamineer.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(MarginExamineer.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : MarginExamineer.share.appUserConfigMode.fullRechargePage)
            url.append(MarginExamineer.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : MarginExamineer.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(MarginExamineer.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : MarginExamineer.share.appUserConfigMode.halfRechargePage)
            url.append(MarginExamineer.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : MarginExamineer.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = MarginExamineer.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = MarginExamineer.share.appUserConfigMode.halfRechargePage.appending((String(showPhoneStr.prefix(5))))
            //: url.append(MarginExamineer.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(MarginExamineer.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
