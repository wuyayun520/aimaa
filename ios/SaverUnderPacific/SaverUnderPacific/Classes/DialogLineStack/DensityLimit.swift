...
fileprivate let showAccuracyKey:[UInt8] = [0x46,0x4b,0x46,0x51,0x5,0x40,0x4c,0x41,0x42,0x4f,0x17,0x6,0xfd,0x45,0x3e,0x50,0xfd,0x4b,0x4c,0x51,0xfd,0x3f,0x42,0x42,0x4b,0xfd,0x46,0x4a,0x4d,0x49,0x42,0x4a,0x42,0x4b,0x51,0x42,0x41]

fileprivate func partyBetween(mortgage num: UInt8) -> UInt8 {
...
/*: "btn_me_edit" :*/
fileprivate let mainLawStr:[Character] = ["b","t","n","_","m","e","_","e","d","i","t"]
...
class DensityLimit: UITableViewCell {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: showAccuracyKey.map{partyBetween(mortgage: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.managerToSecond(name: (String(mainLawStr))))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.textColor = UIColor.systemRequest()
...
extension DensityLimit {
    //: func setCellMessage(titile: String, row: Int, isLast: Bool) {
    func particle(titile: String, row: Int, isLast: Bool) {
    ...
    func evaluationEx(detail: String) {
    ...
    func flexible() {
        ...
        titleBLB.font = UIFont.yearNearby(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.yearNearby(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
