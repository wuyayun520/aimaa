...
fileprivate let appSplitTitle:[UInt8] = [0x50,0x57,0x50,0x4d,0x11,0x5a,0x56,0x5d,0x5c,0x4b,0x3,0x10,0x19,0x51,0x58,0x4a,0x19,0x57,0x56,0x4d,0x19,0x5b,0x5c,0x5c,0x57,0x19,0x50,0x54,0x49,0x55,0x5c,0x54,0x5c,0x57,0x4d,0x5c,0x5d]

private func tailWire(core num: UInt8) -> UInt8 {
    return num ^ 57
}

/*: "icon_lounge" :*/
fileprivate let constResourceCarrierData:[Character] = ["i","c","o","n","_","l","o","u"]
fileprivate let showChoiceValue:String = "NGE"

/*: "#777777" :*/
fileprivate let showPoloId:[Character] = ["#","7"]
fileprivate let app_yetName:String = "77777"

/*: "UID: :*/
fileprivate let dataAttributeStr:String = "processing activeUID:"
...
class HiddenAbout: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: appSplitTitle.map{tailWire(core: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.managerToSecond(name: (String(constResourceCarrierData) + showChoiceValue.lowercased()))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.font = UIFont.yearNearby(type: .Regular, fontSize: 15)
        //: lab.textColor = UIColor(hex: "#777777")
        lab.textColor = UIColor(hex: (String(showPoloId) + app_yetName.capitalized))
        //: return lab
        return lab
        //: }()
    }()
...
extension HiddenAbout {
    ...
    private func informationEnable() {
