...
struct SpecifySmart: HandyJSON {
    ...
    var momentPic: WouldHidden?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [YellowScaleCanvas]? // 相册
    ...
    var aiExtraInfo = CoordinatorGesture() // AI模型
    //: var vipSkinId = 0
...
struct WouldHidden: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [ReceiverRequestModel]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct ReceiverRequestModel: HandyJSON {
...
struct YellowScaleCanvas: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func black(compareTo: YellowScaleCanvas) -> Bool {
        //: return
        return
...
struct CoordinatorGesture: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
