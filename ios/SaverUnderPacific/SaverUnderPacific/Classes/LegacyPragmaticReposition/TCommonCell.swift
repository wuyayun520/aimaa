...
@objcMembers public class SpineSuccess: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func composition(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class MediaProjection: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: SpineSuccess?
    ...
    @objc dynamic public func satisfyAssociated(with data: SpineSuccess) {
        //: self.data = data
        self.data = data
    }
} 