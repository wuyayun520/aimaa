...
/*: ".png" :*/
fileprivate let constCornerKey:String = "maintain behind.png"
...
//: @objcMembers public class TalkingChatImageMsgCellData: TalkingChatMsgBaseCellData {
@objcMembers public class DelayComposition: DisplayOrigin {
    ...
    override public var msgModel: EnhanceModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.social(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func product(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(show_viewBottomName)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + MarginExamineer.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + MarginExamineer.share.loginUserMode.userID + (String(constCornerKey.suffix(4)))
        ...
        let imageData = UIImage.tillTier(image, pushIn: 2 * 1024)
