...
fileprivate let notiMidStr:[UInt8] = [0x38,0x3f,0x38,0x25,0x79,0x32,0x3e,0x35,0x34,0x23,0x6b,0x78,0x71,0x39,0x30,0x22,0x71,0x3f,0x3e,0x25,0x71,0x33,0x34,0x34,0x3f,0x71,0x38,0x3c,0x21,0x3d,0x34,0x3c,0x34,0x3f,0x25,0x34,0x35]

private func galleryAbout(logic num: UInt8) -> UInt8 {
    return num ^ 81
}

/*: "#F5F5F5" :*/
fileprivate let notiAccuracyData:[Character] = ["#","F","5","F","5","F","5"]

/*: "level_ :*/
fileprivate let showCeilingKey:String = "medal have rolelevel_"
...
class PhaseView: UITableViewCell {
    //: var currenModel = TalkingLiveRoomOnlineListModel()
    var currenModel = VolumeOccasionModel()
    //: var index = 0
    var index = 0
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: notiMidStr.map{galleryAbout(logic: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var indexLB: UILabel = {
        ...
        label.font = .yearNearby(type: .Regular, fontSize: 20)
    ...
    lazy var lineView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(notiAccuracyData)))
        //: return view
        return view
        //: }()
    }()
...
extension PhaseView {
    ...
    func stack(model: VolumeOccasionModel, index: Int) {
        //: currenModel = model
        currenModel = model
        //: self.index = index
        self.index = index
        ...
        IconImg.poolFee(urlStr: model.headPic)
        //: nameLabel.text = model.nickname
        nameLabel.text = model.nickname
        //: levelIcon.image = UIImage.BundleImageNamed(name: "level_\(model.level )")
        levelIcon.image = UIImage.managerToSecond(name: (String(showCeilingKey.suffix(6))) + "\(model.level)")
    }
}
