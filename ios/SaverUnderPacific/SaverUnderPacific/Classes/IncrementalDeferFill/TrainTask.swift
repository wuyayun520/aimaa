...
class TrainTask: HandyJSON {
    //: var roomId = ""                           // trtc房间号
    var roomId = "" // trtc房间号
    //: var streamerInfo = TalkingStreamerInfo()
    var streamerInfo = FrameworkLoad() // 主播信息
    //: var livePlayUrl = ""                      // CDN旁路直播拉流地址
    var livePlayUrl = "" // CDN旁路直播拉流地址
    //: var gameList = [TalkingGameListModel]()
    var gameList = [ExecuteMemberSmall]() // 游戏列表
...
class ExecuteMemberSmall: HandyJSON {
    //: var name = ""
    var name = ""
    //: var icon = ""
    var icon = ""
