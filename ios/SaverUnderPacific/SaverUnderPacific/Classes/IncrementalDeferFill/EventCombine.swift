...
fileprivate let mainIndicatorData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Cancel" :*/
fileprivate let main_kingUrl:[Character] = ["C","a","n","c","e","l"]

/*: "Sure" :*/
fileprivate let kUpStr:[Character] = ["S","u","r","e"]
...
class EventCombine: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: mainIndicatorData.reversed(), encoding: .utf8)!)
    }

    //: private func setupView() {
    private func selectedOfExample() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(painterPlatform))
        ...
        cancelButton.setTitle((String(main_kingUrl)).localized, for: .normal)
        //: cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: cancelButton.setTitleColor(UIColor.black, for: .normal)
        cancelButton.setTitleColor(UIColor.black, for: .normal)
        //: cancelButton.addTarget(self, action: #selector(cancelClick(button:)), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(hangCreateer(button:)), for: .touchUpInside)
        ...
        confirmButton.setTitle((String(kUpStr)).localized, for: .normal)
        //: confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: confirmButton.setTitleColor(UIColor.black, for: .normal)
        confirmButton.setTitleColor(UIColor.black, for: .normal)
        //: confirmButton.addTarget(self, action: #selector(confirmClick(button:)), for: .touchUpInside)
        confirmButton.addTarget(self, action: #selector(beforeTerrific(button:)), for: .touchUpInside)
    ...
    @objc func hangCreateer(button: UIButton) {
        //: dismissView()
        painterPlatform()
    }

    //: @objc func confirmClick(button: UIButton) {
    @objc func beforeTerrific(button: UIButton) {
        //: dismissView()
        painterPlatform()
    }
