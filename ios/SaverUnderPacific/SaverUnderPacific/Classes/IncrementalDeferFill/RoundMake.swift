...
extension RoundMake {
    ...
    func shapeEach(_ frontCamera: Bool) {
        ...
        self.performGuideCanvas(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func totalTexture(_ openCamera: Bool) {
        ...
        self.plainAnswer(isOpen: openCamera)
    }
    ...
    func moveFor() {
        ...
        DispatchQueue.main.async {
            ...
            self.foundBullet(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension RoundMake {
    ...
    private func performGuideCanvas(front: Bool) {
    ...
    private func plainAnswer(isOpen: Bool) {
        //: if isOpen {
        if isOpen {
...
extension RoundMake {
    ...
    func needGate() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(speakerSchedule(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(marginMonth(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(beginComprehensive(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(cutDatabase(notif:)),
    ...
    @objc private func speakerSchedule(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func marginMonth(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func beginComprehensive(notif: Notification) {
    ...
    @objc func cutDatabase(notif: Notification) {
...
extension RoundMake {
    ...
    func foundBullet(smallWindow: Bool) {
