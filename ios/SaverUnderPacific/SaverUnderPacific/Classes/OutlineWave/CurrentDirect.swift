...
open class CurrentDirect: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = CurrentDirect.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
