...
fileprivate let show_themeViewUrl:[UInt8] = [0xc3,0xc8,0xc3,0xce,0x82,0xbd,0xc9,0xbe,0xbf,0xcc,0x94,0x83,0x7a,0xc2,0xbb,0xcd,0x7a,0xc8,0xc9,0xce,0x7a,0xbc,0xbf,0xbf,0xc8,0x7a,0xc3,0xc7,0xca,0xc6,0xbf,0xc7,0xbf,0xc8,0xce,0xbf,0xbe]

fileprivate func normHick(foundation num: UInt8) -> UInt8 {
...
class TrackQueryer: UITableViewCell {
    //: lazy var menuImageView: UIImageView = self.makeMenuImageView()
    lazy var menuImageView: UIImageView = self.lockMeasure()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.behindOval()
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: show_themeViewUrl.map{normHick(foundation: $0)}, encoding: .utf8)!)
    }
    ...
    private func lockMeasure() -> UIImageView {
    ...
    private func behindOval() -> UILabel {
    ...
    private func decide() {
        ...
        lineLayer.strokeColor = UIColor.our(230, 230, 230, 1.0).cgColor
