...
@objcMembers public class GraphicRound: NSObject {
    ...
    class func emptyAdd() -> GraphicRound {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = GraphicRound.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func answerForBind() -> GraphicRound {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = GraphicRound.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func propertyWithoutSample() -> GraphicRound {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = GraphicRound.init(isIncomming: false)
    ...
    class func missBit() -> GraphicRound {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = GraphicRound.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func buildResign() -> GraphicRound {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = GraphicRound.init(isIncomming: false)
        //: return layout
        return layout
