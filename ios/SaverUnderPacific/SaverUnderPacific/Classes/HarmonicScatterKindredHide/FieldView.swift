...
fileprivate let noti_oldDuringMessage:[UInt8] = [0x9d,0xa2,0x9d,0xa8,0x5c,0x97,0xa3,0x98,0x99,0xa6,0x6e,0x5d,0x54,0x9c,0x95,0xa7,0x54,0xa2,0xa3,0xa8,0x54,0x96,0x99,0x99,0xa2,0x54,0x9d,0xa1,0xa4,0xa0,0x99,0xa1,0x99,0xa2,0xa8,0x99,0x98]

fileprivate func sharedElement(sh num: UInt8) -> UInt8 {
...
class FieldView: UITextView {
    /// 占位文字
    //: var placeholder: String?
    var placeholder: String?
    /// 占位文字颜色
    //: var placeholderColor: UIColor? = UIColor.appValueDetailColor()
    var placeholderColor: UIColor? = UIColor.theProvision()
...
//    var PlaceholderInsets: UIEdgeInsets = UIEdgeInsets(top: 5, left: 5, bottom: 5, right: 5)
    ...
    override init(frame: CGRect, textContainer: NSTextContainer?) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(borderWith(_:)), name: UITextView.textDidChangeNotification, object: nil)
    }
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: noti_oldDuringMessage.map{sharedElement(sh: $0)}, encoding: .utf8)!)
    }
    ...
    @objc func borderWith(_ note: Notification) {
        // 会重新调用drawRect:方法
