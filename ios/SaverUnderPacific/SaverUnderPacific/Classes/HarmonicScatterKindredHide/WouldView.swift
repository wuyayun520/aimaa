...
/*: "icon_randow_user_bg" :*/
fileprivate let showBigName:String = "successfully"
fileprivate let kSessionIonPath:[Character] = ["c","o","n","_","r","a","n","d","o","w","_","u","s","e","r","_","b","g"]
...
class WouldView: UIView {
    ...
    private let leftAvatarView = DismissTolerance()
    //: private let centerAvatarView = AvatarView()
    private let centerAvatarView = DismissTolerance()
    //: private let rightAvatarView = AvatarView()
    private let rightAvatarView = DismissTolerance()
    ...
    private func exceptionRobot() {
        ...
        centerBgView.image = UIImage.managerToSecond(name: (showBigName.replacingOccurrences(of: "successfully", with: "i") + String(kSessionIonPath)))
    }

    //: private func updateAvatarDisplay() {
    private func flowFor() {
...
extension WouldView {
    ...
    func plateOriginal(avatars: [String]) {
        ...
        flowFor()
        //: startAutoScroll()
        projectionScientific()
    }

    //: func startAutoScroll() {
    func projectionScientific() {
        //: stopAutoScroll()
        isolate()
...
class DismissTolerance: UIView {
    ...
    private func red() {
        ...
        imageView.poolFee(urlStr: self.imageurl ?? "")
    }
}
