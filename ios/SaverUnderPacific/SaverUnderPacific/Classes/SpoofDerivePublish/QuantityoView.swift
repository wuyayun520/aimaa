...
fileprivate let notiCaptureFormat:[UInt8] = [0x9f,0x98,0x9f,0x82,0xde,0x95,0x99,0x92,0x93,0x84,0xcc,0xdf,0xd6,0x9e,0x97,0x85,0xd6,0x98,0x99,0x82,0xd6,0x94,0x93,0x93,0x98,0xd6,0x9f,0x9b,0x86,0x9a,0x93,0x9b,0x93,0x98,0x82,0x93,0x92]
...
class QuantityoView: UIView {
    //: private var giftSendItem = [TalkingGiftNumArrModel()]
    private var giftSendItem = [SClip()]
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: notiCaptureFormat.map{$0^246}, encoding: .utf8)!)
    }
    ...
    func unique(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.obtainOf()
    ...
    func permissionMight(frame: CGRect) {
        //: self.frame = frame
        self.frame = frame
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.our(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.our(253, 170, 52, 1).cgColor, // 深黄
        ]
...
extension QuantityoView {
    // 添加视图
    //: private func setupSubviews() {
    private func instanceHero() {
