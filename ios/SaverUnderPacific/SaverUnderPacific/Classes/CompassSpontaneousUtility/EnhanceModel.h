...
@protocol StructureModel
//: @end
@end
//: @interface QuestionQuickReplayModel: JSONModel
@interface StructureModel: JSONModel
...
@property (nonatomic, strong) EaseModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) PermanentModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) UserStageModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) LocalModel *wantGift; /// 想要礼物
...
@property (nonatomic, strong) NSArray<StructureModel> *replay; /// v1.9.8 男性用户需要回复的选择内容
...
@interface PermanentModel: JSONModel
...
@interface UserStageModel: JSONModel
...
@interface PropertyCharacteristicModel : JSONModel
...
@interface TransitionResumeAgileHeapModel : JSONModel
...
@property (nonatomic, strong) ConnectModel *renderData;
...
@interface ConnectModel : JSONModel
