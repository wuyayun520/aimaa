...
fileprivate let k_scenarioName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class JoinRebuild: TemporaryFrame {
    // 播放结束Block
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: k_scenarioName.reversed(), encoding: .utf8)!)
    }
...
extension JoinRebuild {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func theAngleBehavior(liveUrl: String) {
...
extension JoinRebuild: TXLivePlayListener {
