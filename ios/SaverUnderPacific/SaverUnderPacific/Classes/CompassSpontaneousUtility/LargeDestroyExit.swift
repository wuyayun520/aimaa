...
/*: "App" :*/
fileprivate let show_allowString:String = "Appmy follow"

/*: "blockList_ :*/
fileprivate let data_agentObserveName:[Character] = ["b","l","o","c","k"]
fileprivate let notiTabMsg:String = "resume distribution parentList_"
...
class LargeDestroyExit: NSObject {
    ...
    func meAcrossTransaction(userId: String) {
    ...
    func bothMission(userId: String) {
    ...
    func efficiency(userId: String) -> Bool {
    ...
    private func switchd() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(show_allowString.prefix(3))))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(data_agentObserveName) + String(notiTabMsg.suffix(5))) + "\(uid)")
        //: return filePath
        return filePath
    }
}
