...
enum DistributionIndependent: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum AboveCommandDensity: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
@objc public enum ActionChecked: Int {
    //: case Unavailable = 0
...
enum WithoutFirst: CaseIterable {
