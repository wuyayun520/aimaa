...
let user_videoUrl = actualWidth(w: 275)
//: let MsgTableViewHeight =  actualWidth(w: 200)
let constLiteOverData = actualWidth(w: 200)
//: let cellLineSpeing = 3
let appFinishProLicensePath = 3 /// cell间距
...
struct LevelModel: HandyJSON {
    ...
    var user: TypicalCustomMonster?
    //: var gift: TalkingGiftMsgAnimatModel?
    var gift: FutureMendSumerval?
    //: var toUser: TalkingDanmuUserInfo?
    var toUser: TypicalCustomMonster?
...
struct TypicalCustomMonster: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var nickname = ""
    var nickname = ""
