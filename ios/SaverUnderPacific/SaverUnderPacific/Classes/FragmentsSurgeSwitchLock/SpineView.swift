...
fileprivate let userCirclePath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Any" :*/
fileprivate let constSizeProblemStr:[Character] = ["A","n","y"]
...
class SpineView: EventCombine {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: userCirclePath.reversed(), encoding: .utf8)!)
    }
    ...
    override func beforeTerrific(button: UIButton) {
        ...
        if selectedValue.count <= 0 {
            ...
            selectedValue = dataArr.first ?? (String(constSizeProblemStr))
        }
...
extension SpineView {
    ...
    func belowFormatTotalegrity(value: String) {
...
extension SpineView: UIPickerViewDelegate, UIPickerViewDataSource {
