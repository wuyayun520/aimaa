...
fileprivate let k_broadSpotTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_me_edit" :*/
fileprivate let data_recoverValue:String = "btn_angle shall receive average quit"
...
// __CLOSE_PRINT__
//
//  DatePersistMinimumProject.swift
//  AbroadTalking
//
...
class DatePersistMinimumProject: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: k_broadSpotTitle.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var rightImgV: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.managerToSecond(name: (String(data_recoverValue.prefix(4)) + "me_edit")))
        //: return imag
        return imag
        //: }()
    }()
...
extension DatePersistMinimumProject {
    /// 刷新
    //: func refreshCell(title: String, value: String) {
    func frontCanvas(title: String, value: String) {
        //: titleLab.text = title
        titleLab.text = title
        //: valueLab.text = value
        valueLab.text = value
