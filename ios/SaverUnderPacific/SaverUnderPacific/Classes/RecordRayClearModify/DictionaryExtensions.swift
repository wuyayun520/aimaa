...
extension Dictionary {
    ...
    public static func cartoon(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func surroundingDown(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.cartoon(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
