...
fileprivate let constFormatQueenData:[UInt8] = [0x8,0xf,0x8,0x15,0x49,0x2,0xe,0x5,0x4,0x13,0x5b,0x48,0x41,0x9,0x0,0x12,0x41,0xf,0xe,0x15,0x41,0x3,0x4,0x4,0xf,0x41,0x8,0xc,0x11,0xd,0x4,0xc,0x4,0xf,0x15,0x4,0x5]

private func itsGiftStroke(transaction num: UInt8) -> UInt8 {
    return num ^ 97
}
...
let kTierEditStr = 3.0

//: class CircleCountdownView: UIView {
class IndexSection: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.obtainOf() {
        //: willSet {
        willSet {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: constFormatQueenData.map{itsGiftStroke(transaction: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.yearNearby(type: .Semibold, fontSize: 19)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.obtainOf().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = kTierEditStr
...
extension IndexSection {
    ...
    func roundingWithHistory(totalTime: Int, currTime: Int) {
