...
fileprivate let showTwoUrl:[UInt8] = [0xdd,0xda,0xdd,0xc0,0x9c,0xd7,0xdb,0xd0,0xd1,0xc6,0x8e,0x9d,0x94,0xdc,0xd5,0xc7,0x94,0xda,0xdb,0xc0,0x94,0xd6,0xd1,0xd1,0xda,0x94,0xdd,0xd9,0xc4,0xd8,0xd1,0xd9,0xd1,0xda,0xc0,0xd1,0xd0]

private func literalUsed(decide num: UInt8) -> UInt8 {
    return num ^ 180
}
...
class PainterHandle: ShadeItem {
    //: var giftData: TalkingChatGiftMsgCellData?
    var giftData: ContextLength?
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: showTwoUrl.map{literalUsed(decide: $0)}, encoding: .utf8)!)
    }
...
extension PainterHandle {
    //: override func fill(with data: TCommonCellData) {
    override func satisfyAssociated(with data: SpineSuccess) {
        //: super.fill(with: data)
        super.satisfyAssociated(with: data)
        //: self.giftData = data as? TalkingChatGiftMsgCellData
        self.giftData = data as? ContextLength
