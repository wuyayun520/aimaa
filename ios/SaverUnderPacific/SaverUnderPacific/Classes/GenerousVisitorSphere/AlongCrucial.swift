...
@objc public enum TrackActiveChannel: UInt {
...
@objc public enum CommandNorm: UInt {
 ...
 */
//: @objcMembers public class AlongCrucial: TCommonCellData {
@objcMembers public class AlongCrucial: SpineSuccess {
    ...
    public var direction: CommandNorm = .MsgDirectionIncoming
    ...
    public var translateStatus: TrackActiveChannel = .MsgTranslate_init
    ...
    public var msgModel: EnhanceModel = EnhanceModel()
    ...
    public var cellLayout: GraphicRound!
    ...
    public init(direction: CommandNorm) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.tillTrigger()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = GraphicRound(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = GraphicRound(isIncomming: false)
    ...
    public override func composition(_ width: CGFloat) -> CGFloat {
