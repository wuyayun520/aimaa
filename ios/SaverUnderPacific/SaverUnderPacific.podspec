...
Pod::Spec.new do |s|
  s.name         = "SaverUnderPacific"
  s.version      = "1.0.0"
  s.summary      = "iOS SaverUnderPacific Module."
  s.author       = { "SaverUnderPacific" => "SaverUnderPacific.me" }
  s.homepage     = "SaverUnderPacific"
  s.source       = { :git => "http://SaverUnderPacific.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'SaverUnderPacific/Classes/**/*'
  s.resources = "SaverUnderPacific/Resources/*.bundle"
#  s.vendored_libraries = 'SaverUnderPacific/Classes/**/*.a'
