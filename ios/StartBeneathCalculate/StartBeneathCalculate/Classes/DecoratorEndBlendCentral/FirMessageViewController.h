 ...
 *
 *  RunningReadHalf 协议和 FirMessageViewController 类。
 *  FirMessageViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 FirMessageViewController 的具体声明。
 *
 ******************************************************************************/
...
@class FirMessageViewController;
//: @class RatioViewCell;
@class RatioViewCell;
//: @class AgoneCellData;
@class AgoneCellData;
...
- (void)rendering:(FirMessageViewController *)controller;
...
- (void)disabledRefer:(FirMessageViewController *)controller;
...
- (BOOL)block:(FirMessageViewController *)controller refShared:(UIView *)view;
...
- (AgoneCellData *)plain:(FirMessageViewController *)controller bold:(V2TIMMessage *)data;
...
- (RatioViewCell *)controllerLayer:(FirMessageViewController *)controller referent:(AgoneCellData *)data;
...
- (void)of:(FirMessageViewController *)controller ask:(RatioViewCell *)cell;
...
- (void)fill:(FirMessageViewController *)controller handle:(RatioViewCell *)cell;
...
- (void)screen:(FirMessageViewController *)controller namePacket:(NSInteger)menuType intervalermingle:(AgoneCellData *)data;
/**
...
- (void)fixedSecure:(FirMessageViewController *)controller noSection:(RatioViewCell *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(AgoneCellData *)cellData;
- (void)outline:(FirMessageViewController *)controller border:(AgoneCellData *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(AgoneCellData *)cellData;
- (void)effective:(FirMessageViewController *)controller before:(AgoneCellData *)cellData;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                         FirMessageViewController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 腾讯云 TUIKit
 *  【模块名称】FirMessageViewController
...
@interface FirMessageViewController : UITableViewController
