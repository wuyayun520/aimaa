...
extension TopReactiveCompatible {
    ...
    @objc private func editOvalMove() {
        //: DisplayAperturePresenter.share.func__pushToUserDetailVC(uid: FacultyReactiveCompatible.share.loginUid)
        DisplayAperturePresenter.share.numbererest(uid: FacultyReactiveCompatible.share.loginUid)
    }
