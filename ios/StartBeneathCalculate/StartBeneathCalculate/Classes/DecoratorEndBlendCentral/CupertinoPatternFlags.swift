...
class CupertinoPatternFlags: UIView {
    ...
    private lazy var msgTableView: UITableView = {
        ...
        table.register(AutoInteractorContainer.self, forCellReuseIdentifier: AutoInteractorContainer.className())
...
extension CupertinoPatternFlags {
...
extension CupertinoPatternFlags: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: AutoInteractorContainer.className(), for: indexPath) as! AutoInteractorContainer
