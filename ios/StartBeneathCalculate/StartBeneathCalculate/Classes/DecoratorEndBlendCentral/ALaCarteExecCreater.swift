...
public struct Config {
    ...
    public static var initialMenuStyle: MovementMenuStyle?

    
    //: public struct MenuCellConfig {        
    public struct AlsoVisual {        
    ...
    public struct ALaCarteExecCreater {
