...
/*: "detection" :*/
fileprivate let notiFosterFormat:[Character] = ["d","e","t","e","c","t","i","o"]
fileprivate let notiSecureKey:[Character] = ["n"]

/*: "aiff" :*/
fileprivate let show_norFormat:String = "aispec"
...
class MotionReactiveCompatible: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = MotionReactiveCompatible()
    ...
    func discount() {
        ...
        let soundFilePath = TaEffectTool.default.globalBird(name: (String(notiFosterFormat) + String(notiSecureKey)), type: (show_norFormat.replacingOccurrences(of: "spec", with: "ff")))
        ...
        let soundCompletionCallback: AudioServicesSystemSoundCompletionProc = { soundID, _ in
            ...
            MotionReactiveCompatible.shared.blindOf()
        }
    ...
    @objc private func directionSource() {
        //: soundDuration += 0.001
        soundDuration += 0.001
    }
