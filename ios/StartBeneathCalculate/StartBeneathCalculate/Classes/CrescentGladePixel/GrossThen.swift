...
extension GrossThen {
    ...
    @objc private func show() {
        ...
        SmartThen.share.followView(isHalfView: true)
    }
...
extension GrossThen: FriendshipObjectProtocol {
    ...
    func totalReplacement() {
        //: var msgCount = 0
        var msgCount = 0
        //: let convLists = [IonV2Listener.shared.topConvList, IonV2Listener.shared.norConvList]
        let convLists = [IonV2Listener.shared.topConvList, IonV2Listener.shared.norConvList]
