...
class RoundPlayerDelegate: UIView {
    ...
    private lazy var videoPlayer: FragmentParameterOpacity = {
...
extension RoundPlayerDelegate {
    ...
    private func utilised() {
        ...
        if self.popView == nil {
            ...
            //: self.popView?.showInView(view: AnimateUnaryAllocator.getWindow())
            self.popView?.ad(view: AnimateUnaryAllocator.frameworkWindow())
