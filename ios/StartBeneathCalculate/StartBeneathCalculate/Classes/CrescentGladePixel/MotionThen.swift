...
public class MotionThen: UIView {
    ...
    var menuBgColor: UIColor? {
        ...
        //: }
    } // = Config.ALaCarteExecCreater.menuBgColor
    // 线条颜色
    ...
    public class func refresh(anchorView: UIView) -> MotionThen {
    ...
    public class func my(anchorView: UIView, titleArray: [String]) -> MotionThen {
    ...
    public class func gameArray(anchorView: UIView, titleArray: [String], imageArray: [UIImage]) -> MotionThen {
...
extension MotionThen: UITableViewDelegate, UITableViewDataSource {
