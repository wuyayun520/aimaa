...
/*: "btn_talk_voice_nor" :*/
fileprivate let const_delayMessage:[Character] = ["b","t","n","_","t"]
fileprivate let app_wePath:String = "broadcast"
fileprivate let kPersonalTitle:String = "lk_voipresentation click"

/*: "btn_talk_voice_pre" :*/
fileprivate let appFormatMessage:String = "slow"
fileprivate let appGlobalName:[Character] = ["t","n","_","t","a","l","k","_","v","o","i","c","e","_","p","r","e"]

/*: "contentSize" :*/
fileprivate let noti_signaturePickName:String = "codateedate"
fileprivate let constExampleTitle:[Character] = ["S","i","z","e"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let main_joinHolderEnoughValue:[UInt8] = [0x12,0x17,0x12,0x1d,0xd1,0xc,0x18,0xd,0xe,0x1b,0xe3,0xd2,0xc9,0x11,0xa,0x1c,0xc9,0x17,0x18,0x1d,0xc9,0xb,0xe,0xe,0x17,0xc9,0x12,0x16,0x19,0x15,0xe,0x16,0xe,0x17,0x1d,0xe,0xd]

fileprivate func tagReady(unless num: UInt8) -> UInt8 {
...
fileprivate let const_bringBlockMsg:[Character] = ["b","t","n","_","t","a","l","k","_","m","o","r","e","_","p","h","o","t"]
fileprivate let show_notePath:String = "o_norour effect user become near"

/*: "btn_news_shotVideo_nor" :*/
fileprivate let const_turnSelectFormat:[Character] = ["b","t","n","_","n","e","w","s","_"]
fileprivate let noti_bigFormat:String = "curriculumhot"

/*: "btn_news_video_nor" :*/
fileprivate let user_feedSkipName:String = "old trigger demandbtn_n"
fileprivate let notiShouldId:[Character] = ["i","d","e","o","_","n","o","r"]

/*: "btn_talk_gift_nor" :*/
fileprivate let dataEnvironmentUrl:String = "char here objectbtn_"
fileprivate let show_coreFailId:String = "answeri"
fileprivate let data_allowSegmentMessage:String = "draft renderft_nor"

/*: "btn_more_game_nor" :*/
fileprivate let dataPastPlusText:String = "execute agree single by manualbtn_"
fileprivate let kOperateFormat:String = "game_nordrop lawn item share"

/*: "F5F5F5" :*/
fileprivate let k_enterLensPath:[Character] = ["F","5","F","5","F","5"]

/*: "btn_talk_send_pre" :*/
fileprivate let appDigitalProfessionalMsg:String = "bathroom closedbtn_t"
fileprivate let kCharacterFormat:String = "crow full everyone blankalk_"

/*: "btn_talk_send_nor" :*/
fileprivate let main_readData:[Character] = ["b","t","n","_","t","a","l","k","_","s"]
fileprivate let kBrightValue:String = "phone signal milk reply hungend_nor"

/*: "#EBEBEB" :*/
fileprivate let app_haveStr:String = "#EBEBEBradical recording widespread fail"

/*: "#999999" :*/
fileprivate let main_inventoryMessage:[Character] = ["#","9","9","9","9","9","9"]

/*: "Free message to send out~" :*/
fileprivate let app_cantName:[Character] = ["F","r","e","e"," ","m","e","s","s"]
fileprivate let showCoreFrontValue:String = "compute advice reader adjust exampleage t"
fileprivate let user_monkeyData:String = "nd out~bass main album stranger representation"

/*: "Type a message…" :*/
fileprivate let notiSuccessfullyName:String = "Type a mless retirement foundation help stroke"
fileprivate let main_fastMsg:String = "essage…place king particular scenario second"

/*: "Hold to talk" :*/
fileprivate let userFitData:String = "always military gray decreaseHold"
fileprivate let user_putData:String = " to talkbottom nor"

/*: "#DDDDDD" :*/
fileprivate let userFeeMessage:String = "#DDDDDDevaluate paper"

/*: "icon_Chat_freetimes" :*/
fileprivate let user_guideKey:[Character] = ["i","c","o","n","_","C","h","a","t","_","f","r","e"]
fileprivate let k_pinTwoValue:[Character] = ["e"]
fileprivate let mainPocketText:[Character] = ["t","i","m","e","s"]

/*: "A maximum of 10 people can be @ one message" :*/
fileprivate let appClearFeeReportedMessage:[UInt8] = [0x58,0x39,0x74,0x78,0x61,0x70,0x74,0x6c,0x74,0x39,0x76,0x7f,0x39,0x28,0x29,0x39,0x69,0x7c,0x76,0x69,0x75,0x7c,0x39,0x7a,0x78,0x77,0x39,0x7b,0x7c,0x39,0x59,0x39,0x76,0x77,0x7c,0x39,0x74,0x7c,0x6a,0x6a,0x78,0x7e,0x7c]

private func petitionOp(verbal num: UInt8) -> UInt8 {
    return num ^ 25
}

/*: "name" :*/
fileprivate let constFavoriteKey:String = "nameet"

/*: "length" :*/
fileprivate let const_editionPopStr:[Character] = ["l","e","n","g","t","h"]

/*: "uid" :*/
fileprivate let noti_enjoyMsg:String = "umelt"

/*: "btn_talk_keyboard_nor" :*/
fileprivate let data_checkProcedureValue:String = "btn_taago short"
fileprivate let userContributionEarlyStr:[Character] = ["y","b","o","a","r"]
fileprivate let appProgramPath:[Character] = ["d","_","n","o","r"]

/*: "btn_talk_keyboard_pre" :*/
fileprivate let main_suspendUnusualTitle:String = "sun enter detail yesterdaybtn_t"
fileprivate let showVisualMessage:String = "premium shadow float stateard_pre"

/*: "wav" :*/
fileprivate let user_creationFormat:[Character] = ["w","a","v"]
...
enum BorderControlAdditiveArithmetic: Int {
    //: case Photo        = 0
    case Photo = 0
    //: case VideoCall
    case VideoCall
...
protocol IonSignalViewDelegate: NSObject {
    ...
    func profileNum(giftModel: ReportedMeasurable, giftNum: String)
...
class ConfirmView: UIView {
    ...
    open weak var delegate: IonSignalViewDelegate?
    //: open var inputStyle: InputViewType = .PrivateChat
    open var inputStyle: GoViewType = .PrivateChat
    //: open var recordView: TalkingChatRecordView?
    open var recordView: DisabledSessionInteraction?

    //: open var quoteModel: AbTalkingChatMsgQuoteModel? {
    open var quoteModel: FirstSolidTitleTheoryModel? {
        //: didSet {
        didSet {
            ...
            if let tempModel = quoteModel {
                ...
                self.voiceBtn.setImage(UIImage.adName(name: (String(const_delayMessage) + app_wePath.replacingOccurrences(of: "broadcast", with: "a") + String(kPersonalTitle.prefix(6)) + "ce_nor")), for: .normal)
                //: self.voiceBtn.setImage(UIImage.BundleImageNamed(name: "btn_talk_voice_pre"), for: .highlighted)
                self.voiceBtn.setImage(UIImage.adName(name: (appFormatMessage.replacingOccurrences(of: "slow", with: "b") + String(appGlobalName))), for: .highlighted)
    ...
    let BackViewHeight = 98 + data_cornerMessage
    ...
    init(type: GoViewType) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(plant(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        ...
        inputTextView.rx.observeWeakly(UITextView.self, (noti_signaturePickName.replacingOccurrences(of: "date", with: "nt") + String(constExampleTitle))).subscribe(onNext: { [weak self] _ in
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_joinHolderEnoughValue.map{tagReady(unless: $0)}, encoding: .utf8)!)
    }
    ...
    private func resistanceBindAction() {
        ...
        giftView.sendActionBlock = { [weak self] (_ giftModel: ReportedMeasurable, _ num: String) in
            ...
            self.delegate?.pointTrack(giftModel: giftModel, giftNum: num)
            //: return
        }
        ...
        giftView.chatRoomSendActionBlock = { [weak self] (_ giftModel: ReportedMeasurable, _ num: String, _ model: RocketTransformable) in
            //: guard let self = self else {return}
            guard let self = self else { return }
            //: self.delegate?.func__sendChatRoomGiftMsg(giftModel: giftModel, giftNum: num, model: model)
            self.delegate?.copernicanSystemA(giftModel: giftModel, giftNum: num, model: model)
            //: return
        }
        ...
        if inputStyle == .PrivateChat || inputStyle == .LiveRoom {
            ...
            if inputStyle == .PrivateChat {
                ...
                giftView.askforActionBlock = { [weak self] (_ giftModel: ReportedMeasurable, _ num: String) in
                    //: guard let self = self else {return}
                    guard let self = self else { return }
                    //: self.delegate?.func__askforGiftMsg(giftModel: giftModel, giftNum: num)
                    self.delegate?.profileNum(giftModel: giftModel, giftNum: num)
                    //: return
                }
            }
        }
    ...
    private func picture() {
        ...
        var arr = [BorderControlAdditiveArithmetic]()
        //: if inputStyle == .PrivateChat {
        if inputStyle == .PrivateChat {
            //: arr = [MoreActionType.Photo,
            arr = [BorderControlAdditiveArithmetic.Photo,
                   //: MoreActionType.ShortVideo,
                   BorderControlAdditiveArithmetic.ShortVideo,
                   //: MoreActionType.VideoCall,
                   BorderControlAdditiveArithmetic.VideoCall,
                   //: MoreActionType.Gift,
                   BorderControlAdditiveArithmetic.Gift,
                   //: MoreActionType.Game]
                   BorderControlAdditiveArithmetic.Game]
            // 游戏入口
            //: let bit = FacultyReactiveCompatible.share.appUserConfigMode.gameShowBit
            let bit = FacultyReactiveCompatible.share.appUserConfigMode.gameShowBit
        ...
        for (i, type) in arr.enumerated() {
            ...
            case .Photo:
                ...
                str = (String(const_bringBlockMsg) + String(show_notePath.prefix(5)))
            //: case .VideoCall:
            case .VideoCall:
                //: str = "btn_news_shotVideo_nor"
                str = (String(const_turnSelectFormat) + noti_bigFormat.replacingOccurrences(of: "curriculum", with: "s") + "Video_nor")
            //: case .ShortVideo:
            case .ShortVideo:
                //: str = "btn_news_video_nor"
                str = (String(user_feedSkipName.suffix(5)) + "ews_v" + String(notiShouldId))
            //: case .Gift:
            case .Gift:
                //: str = "btn_talk_gift_nor"
                str = (String(dataEnvironmentUrl.suffix(4)) + "talk_" + show_coreFailId.replacingOccurrences(of: "answer", with: "g") + String(data_allowSegmentMessage.suffix(6)))
            //: case .Game:
            case .Game:
                //: str = "btn_more_game_nor"
                str = (String(dataPastPlusText.suffix(4)) + "more_" + String(kOperateFormat.prefix(8)))
            }
            //: let btn = UIButton.init()
            let btn = UIButton()
            //: btn.setImage(UIImage.BundleImageNamed(name: str), for: .normal)
            btn.setImage(UIImage.adName(name: str), for: .normal)
            //: btn.setImage(UIImage.BundleImageNamed(name: str), for: .highlighted)
            btn.setImage(UIImage.adName(name: str), for: .highlighted)
            //: btn.imageView?.contentMode = .scaleAspectFill
            btn.imageView?.contentMode = .scaleAspectFill
            //: btn.tag = type.rawValue
            btn.tag = type.rawValue
            //: btn.addTarget(self, action: #selector(moreAction(sender:)), for: .touchUpInside)
            btn.addTarget(self, action: #selector(listen(sender:)), for: .touchUpInside)
            //: bottomView.addSubview(btn)
            bottomView.addSubview(btn)
            //: btn.snp.makeConstraints { (make) in
            btn.snp.makeConstraints { make in
                //: make.leading.equalTo(ScreenWidth/5.0 * CGFloat(i))
                make.leading.equalTo(main_assetUrl / 5.0 * CGFloat(i))
                //: make.top.height.equalToSuperview()
                make.top.height.equalToSuperview()
                //: make.width.equalTo(ScreenWidth/5)
                make.width.equalTo(main_assetUrl / 5)
            }
            //: if type == .VideoCall {
            if type == .VideoCall {
                //: self.callbtn = btn
    ...
    @objc func eastern(sender: UIButton) {
    ...
    @objc func listen(sender: UIButton) {
        //: self.inputTextView.resignFirstResponder()
        self.inputTextView.resignFirstResponder()
        //: guard let actionType = MoreActionType.init(rawValue: sender.tag) else { return }
        guard let actionType = BorderControlAdditiveArithmetic(rawValue: sender.tag) else { return }
        //: if actionType == .Gift {
        if actionType == .Gift {
            //: clickgiftBtn()
            raw()
            ...
            self.delegate?.componentBy(actionType: actionType)
        }
    }
    ...
    lazy var contentView: UIView = {
        ...
        content.backgroundColor = UIColor(hex: (String(k_enterLensPath)))
    ...
    lazy var voiceBtn: UIButton = {
        ...
        voice.setImage(UIImage.adName(name: (String(const_delayMessage) + app_wePath.replacingOccurrences(of: "broadcast", with: "a") + String(kPersonalTitle.prefix(6)) + "ce_nor")), for: .normal)
        //: voice.setImage(UIImage.BundleImageNamed(name: "btn_talk_voice_pre"), for: .highlighted)
        voice.setImage(UIImage.adName(name: (appFormatMessage.replacingOccurrences(of: "slow", with: "b") + String(appGlobalName))), for: .highlighted)
        //: voice.addTarget(self, action: #selector(clickVoiceBtn(sender:)), for: .touchUpInside)
        voice.addTarget(self, action: #selector(wait(sender:)), for: .touchUpInside)
    ...
    lazy var sendBtn: UIButton = {
        ...
        sendction.setImage(UIImage.adName(name: (String(appDigitalProfessionalMsg.suffix(5)) + String(kCharacterFormat.suffix(4)) + "send_pre")), for: .normal)
        //: sendction.setImage(UIImage.BundleImageNamed(name: "btn_talk_send_nor"), for: .selected)
        sendction.setImage(UIImage.adName(name: (String(main_readData) + String(kBrightValue.suffix(7)))), for: .selected)
        //: sendction.addTarget(self, action: #selector(clickSendBtn(sender:)), for: .touchUpInside)
        sendction.addTarget(self, action: #selector(eastern(sender:)), for: .touchUpInside)
    ...
    lazy var quoteView: SuiteQuoteView = {
        //: let quoteV = InputQuoteView()
        let quoteV = SuiteQuoteView()
        //: quoteV.isHidden = true
        quoteV.isHidden = true
        //: quoteV.layer.cornerRadius = 14
        quoteV.layer.cornerRadius = 14
        //: quoteV.backgroundColor = UIColor(hex: "#EBEBEB")
        quoteV.backgroundColor = UIColor(hex: (String(app_haveStr.prefix(7))))
    ...
    lazy var inputTextView: InListviewReducer = {
        ...
        input.placeholderColor = .init(hex: (String(main_inventoryMessage))) ?? UIColor.gray
        ...
        if FacultyReactiveCompatible.share.loginUserMode.freeMsgTimes.count > 0 {
            ...
            input.placeholder = (String(app_cantName) + String(showCoreFrontValue.suffix(5)) + "o se" + String(user_monkeyData.prefix(7))).localized
            //: } else {
        } else {
            //: input.placeholder = "Type a message…".localized
            input.placeholder = (String(notiSuccessfullyName.prefix(8)) + String(main_fastMsg.prefix(7))).localized
        }
        ...
        input.textColor = UIColor.mottleResult()
        //: self.inputAttr = [NSAttributedString.Key.foregroundColor: UIColor.mottleResult(), .font: UIFont.pingfangFont(type: .Regular, fontSize: 16)]
        self.inputAttr = [NSAttributedString.Key.foregroundColor: UIColor.mottleResult(), .font: UIFont.recipeDecision(type: .Regular, fontSize: 16)]
    ...
    lazy var recordButton: UIButton = {
        ...
        record.setTitle((String(userFitData.suffix(4)) + String(user_putData.prefix(8))).localized, for: .normal)
        //: record.titleLabel?.font = .pingfangFont(type: .Regular, fontSize: 16)
        record.titleLabel?.font = .recipeDecision(type: .Regular, fontSize: 16)
        //: record.setTitleColor(UIColor.mottleResult(), for: .normal)
        record.setTitleColor(UIColor.mottleResult(), for: .normal)
        //: record.setBackgroundColor(color: .white, forState: .normal)
        record.askPath(color: .white, forState: .normal)
        //: record.setBackgroundColor(color: .white, forState: .highlighted)
        record.askPath(color: .white, forState: .highlighted)
        //: record.addTarget(self, action: #selector(recordBtnDown), for: .touchDown)
        record.addTarget(self, action: #selector(cardinal), for: .touchDown)
        //: record.addTarget(self, action: #selector(recordBtnUp), for: .touchUpInside)
        record.addTarget(self, action: #selector(memorabiliaShape), for: .touchUpInside)
        //: record.addTarget(self, action: #selector(recordBtnCancel), for: [.touchUpOutside, .touchCancel])
        record.addTarget(self, action: #selector(mp), for: [.touchUpOutside, .touchCancel])
        //: record.addTarget(self, action: #selector(recordBtnExit), for: .touchDragExit)
        record.addTarget(self, action: #selector(automatically), for: .touchDragExit)
        //: record.addTarget(self, action: #selector(recordBtnEnter), for: .touchDragEnter)
        record.addTarget(self, action: #selector(orientationEnter), for: .touchDragEnter)
        //: record.layer.borderWidth = 1
        record.layer.borderWidth = 1
        //: record.layer.cornerRadius = 20
        record.layer.cornerRadius = 20
        //: record.layer.borderColor = UIColor.init(hex: "#DDDDDD")?.cgColor
        record.layer.borderColor = UIColor(hex: (String(userFeeMessage.prefix(7))))?.cgColor
    ...
    lazy var giftView: LiteralViewDelegate = {
        ...
        var type = LikewiseClusterLiteral.normal
        ...
        let giftV = LiteralViewDelegate(style: type)
    ...
    lazy var freeImg: UIImageView = {
        ...
        img.image = UIImage.adName(name: (String(user_guideKey) + String(k_pinTwoValue) + String(mainPocketText)))
        //: return img
        return img
        //: }()
    }()
...
extension ConfirmView {
    ...
    func times() {
        ...
        inputTextView.placeholder = (String(notiSuccessfullyName.prefix(8)) + String(main_fastMsg.prefix(7))).localized
    }
}

//: extension TalkingChatInputView: UITextViewDelegate {
extension ConfirmView: UITextViewDelegate {
    ...
    func textView(_: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
        ...
        if self.inputStyle == .GroupChat && text == "@" && solution() < 10 {
            //: self.delegate?.func__selectMentionUser(range: NSRange(location: range.location, length: text.utf16.count))
            self.delegate?.degree(range: NSRange(location: range.location, length: text.utf16.count))
        }
    ...
    func footnote() {
        ...
        self.delegate?.build(height: textHeight + data_cornerMessage + 58 + (self.quoteView.isHidden ? 0 : 36))
    }

    //: @objc func keyboardWasShown(notification: NSNotification) {
    @objc func plant(notification: NSNotification) {
        ...
        if !showOtherInputView {
            ...
            self.delegate?.low(heightToBottom: height)
        }
    }
    ...
    @objc func notification(notification _: NSNotification) {
        ...
        self.delegate?.low(heightToBottom: 0)
    }
}
...
extension ConfirmView {
    ...
    func empty() {
        ...
        if self.inputStyle == .GroupChat { // 群聊
            ...
            let sendStr = self.blend(text: self.inputTextView.attributedText)
            //: self.delegate?.func__sendTextMsg(msgStr: sendStr, quoteModel: quoteModel)
            self.delegate?.flag(msgStr: sendStr, quoteModel: quoteModel)
            ...
            self.delegate?.flag(msgStr: inputTextView.text, quoteModel: quoteModel)
        }
        //: self.quoteModel = nil
        self.quoteModel = nil
...
extension ConfirmView {
    ...
    private func solution() -> Int {
        ...
        if count >= 10 {
            ...
            self.micromicronProcess(showMsg: String(bytes: appClearFeeReportedMessage.map{petitionOp(verbal: $0)}, encoding: .utf8)!.localized)
        }
    ...
    func springDict(range: NSRange?, dict: [String: Any]) {
        //: guard calculateAtCount() < 10 else { return }
        guard solution() < 10 else { return }
        //: var atRange = range
        var atRange = range
        //: if atRange != nil {
        if atRange != nil { // 输入框@
...
//                    atRange!.location -= 1
        ...
        let atStr = "@\(dict[(constFavoriteKey.replacingOccurrences(of: "meet", with: "me"))] ?? "")"
        //: let label = UILabel()
        let label = UILabel()
        ...
        atInfo[(String(const_editionPopStr))] = atStr.count
    ...
    private func blend(text: NSAttributedString?) -> String {
        ...
        if self.inputStyle == .GroupChat {
            ...
            mText.enumerateAttributes(in: NSRange(location: 0, length: mText.length)) { attrs, range, _ in
                ...
                if atta != nil && range.length == 1 {
                    ...
                    if let name = atta!.atInfo[(constFavoriteKey.replacingOccurrences(of: "meet", with: "me"))] {
                        //: let str = "<at>@\(name)</at> "
                        let str = "<at>@\(name)</at> "
                        //: string.append(str)
                        string.append(str)
                        //: self.atArr.append(atta!.atInfo["uid"]! as! String)
                        self.atArr.append(atta!.atInfo[(noti_enjoyMsg.replacingOccurrences(of: "melt", with: "id"))]! as! String)
                    }
                    //: } else {
                } else {
...
extension ConfirmView {
    ...
    @objc func raw() {
        ...
        RecognizeReactiveCompatible.share.connectView(type: type, completion: {
...
extension ConfirmView {
    ...
    @objc func wait(sender: UIButton) {
        //: TalkingPermissionTool.func__openRecordServiceWithBlock(true) { [weak self]  (isOpen: Bool) in
        ActivityReactiveCompatible.intervalensityLevel(true) { [weak self] (isOpen: Bool) in
            //: guard let self = self else {return}
            guard let self = self else { return }
            //: if isOpen {
            if isOpen {
                ...
                if sender.isSelected {
                    ...
                    sender.setImage(UIImage.adName(name: (String(data_checkProcedureValue.prefix(6)) + "lk_ke" + String(userContributionEarlyStr) + String(appProgramPath))), for: .normal)
                    //: sender.setImage(UIImage.BundleImageNamed(name: "btn_talk_keyboard_pre"), for: .highlighted)
                    sender.setImage(UIImage.adName(name: (String(main_suspendUnusualTitle.suffix(5)) + "alk_keybo" + String(showVisualMessage.suffix(7)))), for: .highlighted)
                    ...
                    sender.setImage(UIImage.adName(name: (String(const_delayMessage) + app_wePath.replacingOccurrences(of: "broadcast", with: "a") + String(kPersonalTitle.prefix(6)) + "ce_nor")), for: .normal)
                    //: sender.setImage(UIImage.BundleImageNamed(name: "btn_talk_voice_pre"), for: .highlighted)
                    sender.setImage(UIImage.adName(name: (appFormatMessage.replacingOccurrences(of: "slow", with: "b") + String(appGlobalName))), for: .highlighted)
                    //: self.recordButton.isHidden = true
                    self.recordButton.isHidden = true
                    //: self.inputTextView.becomeFirstResponder()
                    self.inputTextView.becomeFirstResponder()
    ...
    @objc func cardinal() {
        ...
        recordView = DisabledSessionInteraction()
        ...
        recordView?.observerStatus(status: .recording)
        ...
        self.delegate?.pointThread()
    }

    //: @objc func recordBtnCancel() {
    @objc func mp() {
        //: guard TalkingSocketManager.shared.isGeneral == false else { return }
        guard ConfigureAxisService.shared.isGeneral == false else { return }
        //: recordView?.hidenView()
        recordView?.harvestLaunch()
        //: cancelRecord(isTooLong: false)
        workFlag(isTooLong: false)
    }

    //: @objc func recordBtnExit() {
    @objc func automatically() {
        //: guard TalkingSocketManager.shared.isGeneral == false else { return }
        guard ConfigureAxisService.shared.isGeneral == false else { return }
        //: recordView?.setRecordStatus(status: .cancel)
        recordView?.observerStatus(status: .cancel)
    }

    //: @objc func recordBtnEnter() {
    @objc func orientationEnter() {
        //: guard TalkingSocketManager.shared.isGeneral == false else { return }
        guard ConfigureAxisService.shared.isGeneral == false else { return }
        //: recordView?.setRecordStatus(status: .recording)
        recordView?.observerStatus(status: .recording)
    ...
    @objc func memorabiliaShape() {
        ...
        if interval < 1.0 || interval > RecordMaxDuration {
            ...
            if interval < 1.0 {
                ...
                recordView?.observerStatus(status: .tooShoot)
                //: } else {
            } else {
                //: recordView?.setRecordStatus(status: .tooLong)
                recordView?.observerStatus(status: .tooLong)
            }

            //: cancelRecord(isTooLong: interval > RecordMaxDuration)
            workFlag(isTooLong: interval > RecordMaxDuration)
            ...
            if path.isEmpty == false {
                ...
                self.delegate?.lastWeekly(voicePath: path, voiceTime: Int(interval))
            }
        }
    }
    ...
    func yearBass() {
        ...
        let path = controlPath(path: (String(user_creationFormat)) as NSString)
        ...
        do {
            ...
            recordTimer = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(visualiser(time:)), userInfo: nil, repeats: true)
    ...
    @objc func visualiser(time _: Timer) {
        //: recorder?.updateMeters()
        recorder?.updateMeters()
        ...
        if interval > RecordMaxDuration {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
                ...
                self.recordView?.harvestLaunch()
                //: })
            }
            //: if path.isEmpty == false {
            if path.isEmpty == false {
                //: self.delegate? .func__sendVoiceMsg(voicePath: path, voiceTime: 30)
                self.delegate?.lastWeekly(voicePath: path, voiceTime: 30)
            }
        }
    }
    ...
    func controlPath(path: NSString) -> String {
        //: if !FileManager.default.fileExists(atPath: Talking_Chat_record_SandboxPath) {
        if !FileManager.default.fileExists(atPath: appPlainFormat) {
            //: do {
            do {
                ...
                try FileManager.default.createDirectory(atPath: appPlainFormat, withIntermediateDirectories: true, attributes: nil)
                //: }catch {
            } catch {}
        }
        ...
        let timestr = NSDate.timeIntervalSinceReferenceDate
        //: let uid = FacultyReactiveCompatible.share.loginUserMode.userID
        let uid = FacultyReactiveCompatible.share.loginUserMode.userID
        //: if uid.count == 0 { return "" }
        if uid.count == 0 { return "" }

        //: return Talking_Chat_record_SandboxPath + "_" + uid + "_" + String(Int(timestr)) + "." + (path as String)
        return appPlainFormat + "_" + uid + "_" + String(Int(timestr)) + "." + (path as String)
    }

    //: func cancelRecord(isTooLong: Bool) {
    func workFlag(isTooLong: Bool) {
        //: if recordTimer != nil {
        if recordTimer != nil {
            //: recordTimer?.invalidate()
            recordTimer?.invalidate()
