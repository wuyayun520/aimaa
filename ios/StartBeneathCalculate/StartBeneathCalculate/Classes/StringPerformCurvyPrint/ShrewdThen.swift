...
class ShrewdThen: UIViewController {
    //: var pageIndex = 0
    var pageIndex = 0
...
extension ShrewdThen {
    ...
    func cookie() {
        ...
        TagThen.theCompletion(params: dict) { succeed, result, errorModel in
...
extension ShrewdThen: UITableViewDelegate, UITableViewDataSource {
...
extension ShrewdThen: UIScrollViewDelegate {
