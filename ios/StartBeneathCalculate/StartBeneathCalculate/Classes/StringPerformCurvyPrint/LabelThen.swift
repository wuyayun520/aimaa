...
class LabelThen: SafetyFactorViewController {
...
extension LabelThen {
    ...
    private func plumageQuality() {
        //: SmartThen.share.func__jumpVideoCallToWebRecharge(popupCallIndex: TalkingVideoInitivCallManager.shared.videoCallModel.popupCallAcceptEvent)
        SmartThen.share.manualMid(popupCallIndex: StrangerManager.shared.videoCallModel.popupCallAcceptEvent)
