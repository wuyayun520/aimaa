...
extension DigitalAnalogConverterModelType {
    ...
    mutating func manageHeight() {
        ...
        let sizeheight = Int(MoviegoerThen.keyTotal(text: tempContent, size: CGSize(width: main_assetUrl - 82, height: CGFloat(MAXFLOAT)), font: UIFont.recipeDecision(type: .Regular, fontSize: 14), lineNumber: 0).height)
