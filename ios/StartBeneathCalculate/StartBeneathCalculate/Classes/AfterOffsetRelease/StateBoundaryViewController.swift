...
class StateBoundaryViewController: SafetyFactorViewController {
    ...
    override func viewDidLoad() {
        ...
        AlsoThen.shared.isGeneral = true
        //: setupSubviews()
        good()
    ...
    private lazy var videoManager: TamperThen = {
...
extension StateBoundaryViewController: PeerViewDelegate {
    ...
    func beforeNeed(isPush: Bool) {
        ...
        //: SmartThen.share.func__jumpVideoCallToWebRecharge(popupCallIndex: FacultyReactiveCompatible.share.appUserConfigMode.popupCallEndEvent)
        SmartThen.share.manualMid(popupCallIndex: FacultyReactiveCompatible.share.appUserConfigMode.popupCallEndEvent)
