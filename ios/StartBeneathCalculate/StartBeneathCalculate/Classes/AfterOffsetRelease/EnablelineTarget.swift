...
class EnablelineTarget: UIView {
    ...
    private lazy var tableView: UITableView = {
        ...
        table.register(EncampThen.self, forCellReuseIdentifier: EncampThen.className())
...
extension EnablelineTarget {
    ...
    private func enablelyData() {
        ...
        FriendshipThen().visible(chatGroupId: self.chatGroupId) { succeed, result, _ in
