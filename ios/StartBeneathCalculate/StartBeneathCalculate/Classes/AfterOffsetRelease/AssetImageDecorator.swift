...
let kSaveKey = AssetImageDecorator()
...
class AssetImageDecorator: NSObject {
    ...
    public func memorabilia(model: AgileCrucialTransformer, completion _: @escaping FinishBlock) {
