...
@objc public enum SuiteStretchCount: UInt {
...
@objc public enum BeAdditiveArithmetic: UInt {
 ...
 */
//: @objcMembers public class AgoneCellData: TCommonCellData {
@objcMembers public class AgoneCellData: CommonalityCellData {
    ...
    public var direction: BeAdditiveArithmetic = .MsgDirectionIncoming
    ...
    public var translateStatus: SuiteStretchCount = .MsgTranslate_init
    ...
    public var msgModel: ReadModel = ReadModel()
    ...
    public var cellLayout: TagReactiveCompatible!
    ...
    public init(direction: BeAdditiveArithmetic) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.scribe()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = TagReactiveCompatible(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = TagReactiveCompatible(isIncomming: false)
    ...
    public override func rankWidth(_ width: CGFloat) -> CGFloat {
