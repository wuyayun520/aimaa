...
@objcMembers class FoundTransformable: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: AudienceMeasurable?
    //: var gift: TalkingMsgGiftModel?
    var gift: AssignTransformable?
    //: var user: TalkingMsgUserModel?
    var user: RangeModelType?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: ConfirmThen?
...
class AudienceMeasurable: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class RangeModelType: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class ConfirmThen: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class AssignTransformable: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
