...
fileprivate let show_audienceData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#292929" :*/
fileprivate let dataDeleteKey:String = "#292929"

/*: "9999999" :*/
fileprivate let const_othersCreamTitle:String = "9999999"

/*: "icon_coin" :*/
fileprivate let mainForceTitle:String = "icagon"

/*: "icon_gift_more_arrow" :*/
fileprivate let kActionData:String = "retainon"
fileprivate let const_attributeMessage:String = "information interested play elect_more_"
fileprivate let mainCommunicationSiblingStr:[Character] = ["w"]

/*: "Hot" :*/
fileprivate let showFavoriteTitle:String = "tar proposal dailyHot"

/*: "VIP" :*/
fileprivate let showProperlyFormat:String = "Vcount"

/*: "Bags" :*/
fileprivate let k_wholeUrl:String = "Bagspost pi heritage"

/*: "icon_gift_num_arrow" :*/
fileprivate let k_holderMessage:[Character] = ["i","c","o","n","_","g","i","f","t","_","n","u"]
fileprivate let data_noticeFormat:[Character] = ["m","_","a","r","r","o","w"]

/*: "Send" :*/
fileprivate let user_objectKey:String = "contrast mineSend"

/*: "nav_back_black_nor" :*/
fileprivate let user_holdMovementFormat:String = "nav_bacbrush behavior"
fileprivate let noti_birdUrl:String = "k_bltap design"

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let data_environmentPath:[UInt8] = [0xad,0x91,0x9c,0xd9,0x97,0x8c,0x94,0x9b,0x9c,0x8b,0xd9,0x96,0x9f,0xd9,0x9e,0x90,0x9f,0x8d,0x8a,0xd9,0x9a,0x98,0x97,0x97,0x96,0x8d,0xd9,0x9b,0x9c,0xd9,0x95,0x9c,0x8a,0x8a,0xd9,0x8d,0x91,0x98,0x97,0xd9,0xc8]

private func topOverall(gap num: UInt8) -> UInt8 {
    return num ^ 249
}

/*: "Please select a gift" :*/
fileprivate let const_historyFullName:String = "sufficient as adjustment mention glassPlease"
fileprivate let userProductAcceptStr:String = "ect circle save crop"
fileprivate let const_blinkId:[Character] = ["f","t"]

/*: "Please select an object" :*/
fileprivate let appAdId:String = "Pleasretirement analyze stat select reply"
fileprivate let mainThroughStepUrl:String = "e selecthave existing today"
fileprivate let userListenStr:String = "appropriate grade remark an o"

/*: "Select the desired gift to unlock" :*/
fileprivate let k_corePath:[UInt8] = [0xef,0xd9,0xd0,0xd9,0xdf,0xc8,0x9c,0xc8,0xd4,0xd9,0x9c,0xd8,0xd9,0xcf,0xd5,0xce,0xd9,0xd8,0x9c,0xdb,0xd5,0xda,0xc8,0x9c,0xc8,0xd3,0x9c,0xc9,0xd2,0xd0,0xd3,0xdf,0xd7]

private func frenchTelephone(consider num: UInt8) -> UInt8 {
    return num ^ 188
}

/*: "Select object >" :*/
fileprivate let showBeforeName:String = "Select obarena stage circle activity logical"
fileprivate let appSomethingFormat:String = "phone normal fence ginject >"

/*: "It looks like there's nothing" :*/
fileprivate let dataRawPath:String = "reception successfully nature constraintIt loo"
fileprivate let user_givingTitle:String = "ke there\'"
fileprivate let notiSunMsg:String = "s notclimb rear discount resistance out"

/*: "FF75A4" :*/
fileprivate let user_galleryId:[Character] = ["F","F","7","5","A"]
fileprivate let const_operationValue:String = "man"

/*: "E570FF" :*/
fileprivate let appRequireRobotFormat:[Character] = ["E","5","7","0","F"]
fileprivate let app_emptyEffPath:[Character] = ["F"]

/*: "Ask for" :*/
fileprivate let mainWedName:String = "Ask foralways destination answer"

/*: " Select %@ > " :*/
fileprivate let showAppStr:[Character] = [" ","S","e","l","e","c","t"," ","%","@"," ",">"," "]

/*: "All Numbers" :*/
fileprivate let userLiveData:String = "context still creamAll "
fileprivate let user_ownName:String = "counter cost precedent anotherNumbers"

/*: "View detailed description >" :*/
fileprivate let const_collectionUrl:String = "View dblock handle oat pan angle"
fileprivate let notiDelayId:String = "led desession oat"
fileprivate let const_eachText:String = "observer well capableon >"

/*: "9999" :*/
fileprivate let mainImmediateUrl:String = "9999"

/*: "Custom" :*/
fileprivate let showRejectId:String = "cookie sale averageCustom"

/*: "mf_coin" :*/
fileprivate let dataTodayKey:String = "reduce menu split mentionmf_co"
fileprivate let appBlindMessage:String = "ibring"

/*: "showBagsRed" :*/
fileprivate let mainTransitionMsg:[Character] = ["s","h","o","w","B","a"]
fileprivate let kLaterAmData:[Character] = ["g","s","R","e","d"]
...
enum LikewiseClusterLiteral: String {
    //: case normal = "0"          // 默认送礼
    case normal = "0" // 默认送礼
...
enum AvailableAfterInsetTarget: Int {
    //: case Hot = 0
    case Hot = 0 // 默认礼物
    //: case Vip = 1
    case Vip = 1 // vip礼物
...
typealias SendFunctionBlock = (_ giftModel: ReportedMeasurable, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: ReportedMeasurable, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: ReportedMeasurable) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: ReportedMeasurable, _ num: String, _ model: RocketTransformable) -> Void
// 隐藏礼物面板Block
...
private let userChangeFormat = 44.0
//: let GiftScrollContentView_H = 252.0
let noti_ageValue = 252.0
//: private let pageControl_H = 7.0
private let app_firstEnableeAllUrl = 7.0
//: private let bottomView_H = 44.0
private let kTitleSaveData = 44.0

//: class TalkingChatGiftView: UIView {
class LiteralViewDelegate: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = userChangeFormat + noti_ageValue + app_firstEnableeAllUrl + kTitleSaveData + data_cornerMessage
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var style: LikewiseClusterLiteral = .normal
    //: var giftSelectedModel = TalkingGiftSelectedModel()
    var giftSelectedModel = MigrationTransformable()
    //: var chatRoomgiftSelectedMemberModel: TalkingChatRoomMemberModel?
    var chatRoomgiftSelectedMemberModel: RocketTransformable?
    //: var popView: TalkingPopView?
    var popView: SpringPopView?
    //: var meneView = DropDownMemberMenuView()
    var meneView = ReferencePointViewDelegate()
    ...
    private var titlesArr = [AvailableAfterInsetTarget]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = AvailableAfterInsetTarget.Hot
    ...
    init(frame: CGRect = .zero, style: LikewiseClusterLiteral = .normal, titlesArr: [AvailableAfterInsetTarget] = [.Hot, .Vip, .Bags]) {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_audienceData.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: kTopUrl, width: main_assetUrl, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (dataDeleteKey.capitalized))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.cornerPopular(width: main_assetUrl, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: main_assetUrl, height: userChangeFormat)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (dataDeleteKey.capitalized))
    ...
    private lazy var moneyBtn: SeparateControlReactiveCompatible = {
        //: let btn = TalkingButton()
        let btn = SeparateControlReactiveCompatible()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.recipeDecision(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((const_othersCreamTitle.capitalized), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.adName(name: (mainForceTitle.replacingOccurrences(of: "ago", with: "o") + "_coin")), for: .normal)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.adName(name: (kActionData.replacingOccurrences(of: "retain", with: "ic") + "_gift" + String(const_attributeMessage.suffix(6)) + "arro" + String(mainCommunicationSiblingStr)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.far(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.far(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        hot.register(AddMomentumBlock.self, forCellWithReuseIdentifier: AddMomentumBlock.className())
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: BeViewLayout = //: return hotGiftCollectionView.collectionViewLayout as! BeViewLayout
        hotGiftCollectionView.collectionViewLayout as! BeViewLayout
    //: }()
    ...
    private lazy var titleScrollView: SpanPeerSegmentView = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(showFavoriteTitle.suffix(3))).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((showProperlyFormat.replacingOccurrences(of: "count", with: "IP")).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(k_wholeUrl.prefix(4))).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = LayoutColorExtension()
        ...
        let scrollview = SpanPeerSegmentView(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(userChangeFormat)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if LocalRouterDescription.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = AnimateUnaryAllocator.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = AnimateUnaryAllocator.areaWidth() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !RecognizeReactiveCompatible.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var sendAreaView: UIView = {
        ...
        view.layer.borderColor = UIColor.crosswise().cgColor
    ...
    private lazy var giftNumButton: SeparateControlReactiveCompatible = {
        ...
        btn.setImage(UIImage.adName(name: (String(k_holderMessage) + String(data_noticeFormat))), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(aidZone), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.recipeDecision(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.crosswise()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(user_objectKey.suffix(4))).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(onTouchSendGiftBtn), for: .touchUpInside)
        btn.addTarget(self, action: #selector(pin), for: .touchUpInside)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: kTopUrl - CGFloat(keyborHeight) - 44, width: main_assetUrl, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.adName(name: (String(user_holdMovementFormat.prefix(7)) + String(noti_birdUrl.prefix(4)) + "ack_nor")).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.askPath(color: .crosswise(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(user_objectKey.suffix(4))).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.micromicronProcess(showMsg: String(bytes: data_environmentPath.map{topOverall(gap: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.micromicronProcess(showMsg: (String(const_historyFullName.suffix(6)) + " sel" + String(userProductAcceptStr.prefix(4)) + "a gi" + String(const_blinkId)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.micromicronProcess(showMsg: (String(appAdId.prefix(5)) + String(mainThroughStepUrl.prefix(8)) + String(userListenStr.suffix(5)) + "bject").localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = AvailableAfterInsetTarget(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.sumeraction(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: ReportedMeasurable = dataArr[index] as! ReportedMeasurable
    ...
    private lazy var giftInputNameLabel: UILabel = {
        ...
        lb.textColor = UIColor.crosswise()
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(standardManage(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(quantityerest(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(downwardRating(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: k_corePath.map{frenchTelephone(consider: $0)}, encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(three), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(showBeforeName.prefix(9)) + String(appSomethingFormat.suffix(6))).localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(outset), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(mediaClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.font = UIFont.recipeDecision(type: .Regular, fontSize: 16)
        //: lab.text = "It looks like there's nothing".localized
        lab.text = (String(dataRawPath.suffix(6)) + "ks li" + user_givingTitle + String(notiSunMsg.prefix(5)) + "hing").localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.announcementSize(colors: [UIColor(hex: (String(user_galleryId) + const_operationValue.replacingOccurrences(of: "man", with: "4")))!.cgColor, UIColor(hex: (String(appRequireRobotFormat) + String(app_emptyEffPath)))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.recipeDecision(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(mainWedName.prefix(7))).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(askforBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(perceiver), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension LiteralViewDelegate {
    ...
    @objc func conCapture() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: kTopUrl, width: main_assetUrl, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func conversion() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: kTopUrl - self.contentHeight, width: main_assetUrl, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func three() {
        ...
        guard let dataType = AvailableAfterInsetTarget(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.sumeraction(dataType: dataType)
    ...
    @objc func outset() {
        ...
        meneView = ReferencePointViewDelegate(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func mediaClick() {
        //: dismissView()
        conCapture()
        //: DisplayAperturePresenter.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        DisplayAperturePresenter.share.joinType(webViewType: .luckyBlindBox)
    }
...
extension LiteralViewDelegate {
    ...
    func punish(pkgItemsetId: String, num: Int) {
        //: guard currType == .Bags else { return }
        guard currType == .Bags else { return }
        //: DispatchQueue.main.async {
        DispatchQueue.main.async {
            //: var bagsDataArr = self.getGiftData(dataType: self.currType) as! [TalkingRoomGiftModel]
            var bagsDataArr = self.sumeraction(dataType: self.currType) as! [ReportedMeasurable]
            // 找到当前背包礼物索引，更新数量
            ...
            RecognizeReactiveCompatible.share.removePitch(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.photosphereForce(force: true)
        }
    }
}

// MARK: - RocketAlsoViewDelegate

//: extension TalkingChatGiftView: DropDownMemberMenuViewDelegate {
extension LiteralViewDelegate: RocketAlsoViewDelegate {
    //: func didClickSelectedRow(model: TalkingChatRoomMemberModel) {
    func processor(model: RocketTransformable) {
        //: self.chatRoomgiftSelectedMemberModel = model
        self.chatRoomgiftSelectedMemberModel = model
        //: seleteObjectBtn.setTitle(" Select %@ > ".localizedArguments(model.nickname), for: .normal)
        seleteObjectBtn.setTitle((String(showAppStr)).extraPropertyLetter(model.nickname), for: .normal)
    }
    ...
    func page() {
        ...
        if model.nickname == (String(userLiveData.suffix(4)) + String(user_ownName.suffix(7))).localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! RocketTransformable
    ...
    func title(title: String) {
        ...
        let str = (String(const_collectionUrl.prefix(6)) + "etai" + String(notiDelayId.prefix(6)) + "scripti" + String(const_eachText.suffix(4))).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension LiteralViewDelegate: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func sumeraction(dataType: AvailableAfterInsetTarget) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return RecognizeReactiveCompatible.share.extractTimeKind(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func tableUs() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return RecognizeReactiveCompatible.share.silken()
    }
    ...
    func pictureUp(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == ResidentScalar.myStery.rawValue)
        }
    ...
    @objc fileprivate func standardManage(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (mainImmediateUrl.capitalized)
            //: } else {
        } else {
    ...
    @objc func downwardRating(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: kTopUrl - CGFloat(keyborHeight) - 44, width: main_assetUrl, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func quantityerest(notification _: NSNotification) {
    ...
    func signalField() {
        ...
        let sendingItems = tableUs()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(startElement(index: i))
//            let giftNumArrModel: EaseModelType = sendingItems[i] as! EaseModelType
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((String(showRejectId.suffix(6))).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.AlsoVisual.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = ControllerSystemScale.gameArray(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func like() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? AddMomentumBlock
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.mention(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = AvailableAfterInsetTarget(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = sumeraction(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = AddMomentumBlock.className()
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! AddMomentumBlock
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = AvailableAfterInsetTarget(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = sumeraction(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: ReportedMeasurable = dataArr[indexPath.row] as! ReportedMeasurable
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.on(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.me(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = AvailableAfterInsetTarget(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = sumeraction(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == ResidentScalar.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == ResidentScalar.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == ResidentScalar.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                ovalOuter(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = say(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = throughTotal(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            ovalOuter(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: AddMomentumBlock = giftSelectedModel.lastHotCell as! AddMomentumBlock
                //: cell.setChecked(checked: false)
                cell.me(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: AddMomentumBlock = self.hotGiftCollectionView.cellForItem(at: indexPath) as! AddMomentumBlock
            //: currentCell.setChecked(checked: true)
            currentCell.me(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.bag(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.sumeraction(dataType: self.currType)
    ...
    func photosphereForce(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + main_assetUrl
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < main_assetUrl ? main_assetUrl : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / main_assetUrl - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(main_assetUrl) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = AvailableAfterInsetTarget.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = RecognizeReactiveCompatible.share.assemblage(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.occur(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && FacultyReactiveCompatible.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == AvailableAfterInsetTarget.Hot && self.style == .normal && FacultyReactiveCompatible.share.loginUserMode.sex == ATextLiteral.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == ResidentScalar.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                self.title(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func accommodate() {
        //: self.giftSelectedModel = TalkingGiftSelectedModel()
        self.giftSelectedModel = MigrationTransformable()
...
// MARK: - IncidentViewDelegate

//: extension TalkingChatGiftView: DropDownMenuViewDelegate {
extension LiteralViewDelegate: IncidentViewDelegate {
    ...
    func temp(index: Int, title: String) {
        ...
        ovalOuter(index: index + 1, title: title)
    }

    //: func  didClickSelectedCellRow(index: Int, title: String) {
    func ovalOuter(index: Int, title _: String) {
        //: let numberOfGift = numberOfGiftForIndex(index: index)
        let numberOfGift = startElement(index: index)
        //: if numberOfGift>0 {
        if numberOfGift > 0 {
            ...
            popView?.quote(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.ad(view: self.window!)
    ...
    func startElement(index: Int) -> Int {
        //: let sendingItems = giftSendItems()
        let sendingItems = tableUs()
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: EaseModelType = sendingItems[index] as! EaseModelType
    ...
    func say(num: Int) -> Int {
        ...
        for i in 0 ..< tableUs().count {
            //: let model: TalkingGiftNumArrModel = giftSendItems()[i] as! TalkingGiftNumArrModel
            let model: EaseModelType = tableUs()[i] as! EaseModelType
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func throughTotal(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > tableUs().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension LiteralViewDelegate {
    ...
    private func remain() {
        ...
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: main_assetUrl, height: kTopUrl - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(conCapture)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(noti_ageValue)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(main_assetUrl)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(main_assetUrl - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(app_firstEnableeAllUrl)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(kTitleSaveData)
        }
    ...
    private func fosterIntervaler() {
        //: FacultyReactiveCompatible.share.loginUserMode.rx
        FacultyReactiveCompatible.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (String(dataTodayKey.suffix(5)) + appBlindMessage.replacingOccurrences(of: "bring", with: "n")))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.pictureUp(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        RecognizeReactiveCompatible.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(mainTransitionMsg) + String(kLaterAmData)))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                RecognizeReactiveCompatible.share.connectView(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: FacultyReactiveCompatible.share.loginUserMode.mf_coin)
                    self.pictureUp(needReload: true, mf_coin: FacultyReactiveCompatible.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
