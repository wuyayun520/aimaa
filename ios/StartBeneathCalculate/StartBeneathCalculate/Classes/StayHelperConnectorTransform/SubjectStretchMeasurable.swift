...
extension SubjectStretchMeasurable {
    ...
    mutating func mark() {
        ...
        let sizeheight = Int(MoviegoerThen.keyTotal(text: tempContent, size: CGSize(width: main_assetUrl - 70, height: CGFloat(MAXFLOAT)), font: UIFont.recipeDecision(type: .Regular, fontSize: 16), lineNumber: 0).height)
