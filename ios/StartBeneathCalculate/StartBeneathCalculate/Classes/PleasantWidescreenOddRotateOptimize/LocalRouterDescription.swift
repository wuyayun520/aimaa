...
@objcMembers open class LocalRouterDescription: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = LocalRouterDescription()
    //: private(set) var currLanguage: String = AnimateUnaryAllocator.getSystemLangCode()
    private(set) var currLanguage: String = AnimateUnaryAllocator.canny()
