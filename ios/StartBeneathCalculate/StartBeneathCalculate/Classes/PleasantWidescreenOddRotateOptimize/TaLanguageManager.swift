...
@objcMembers open class TaLanguageManager: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = TaLanguageManager()
    //: private(set) var currLanguage: String = MacroBorderDefineThen.getSystemLangCode()
    private(set) var currLanguage: String = MacroBorderDefineThen.canny()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func contentOfWords(_ language: String) {
...
extension String {
    ...
    public func extraPropertyLetter(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let language = TaLanguageManager.shared.currLanguage
        //: let languageFolder = SVGAEffectTool.default.languagePath
        let languageFolder = TaEffectTool.default.languagePath
