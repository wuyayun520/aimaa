...
extension ThreeThen {
    ...
    @objc private func spend() {
        ...
        if userInfoModel.isSendQuickMsg == 0, FacultyReactiveCompatible.share.loginUserMode.sex == ATextLiteral.male.rawValue {
            ...
            //: SmartThen.share.func__pushToPriveteChatVC(chatID: userInfoModel.uid)
            SmartThen.share.aboveCompletion(chatID: userInfoModel.uid)
    ...
    func swallow(_ userModel: SeekGoMeasurable) {
        ...
        if userModel.uid == FacultyReactiveCompatible.share.loginUid { // 本人资料页
            ...
            return
                    ...
                    //: } else if FacultyReactiveCompatible.share.loginUid != MacroBorderDefineThen.getCustomerServiceID(),
        } else if FacultyReactiveCompatible.share.loginUid != MacroBorderDefineThen.receiveRemove(),
