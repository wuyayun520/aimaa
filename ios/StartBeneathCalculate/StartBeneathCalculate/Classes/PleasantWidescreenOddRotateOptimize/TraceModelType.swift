...
let kRateData = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let appClickName = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let userMarginReadCountName = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct TraceModelType: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
