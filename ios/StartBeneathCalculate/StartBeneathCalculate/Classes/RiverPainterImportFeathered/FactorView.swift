...
fileprivate let appExploreUrl:String = "tendency column illegal inventorybtn_"
fileprivate let constReduceUrl:String = "ack_cocomposition character recipe transfer"

/*: "init(coder:) has not been implemented" :*/
fileprivate let userSaltMsg:[UInt8] = [0x1d,0x22,0x1d,0x28,0xdc,0x17,0x23,0x18,0x19,0x26,0xee,0xdd,0xd4,0x1c,0x15,0x27,0xd4,0x22,0x23,0x28,0xd4,0x16,0x19,0x19,0x22,0xd4,0x1d,0x21,0x24,0x20,0x19,0x21,0x19,0x22,0x28,0x19,0x18]

fileprivate func rangeMethod(clip num: UInt8) -> UInt8 {
...
class FactorView: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(creationDoing), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(abstraction), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: InstAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(appExploreUrl.suffix(4)) + "me_b" + String(constReduceUrl.prefix(6)) + "ntinue")
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userSaltMsg.map{rangeMethod(clip: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func transfer(title: String, isTouch: Bool) {
