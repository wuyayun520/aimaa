...
class AlsoHandyJSON: HandyJSON {
    //: var roomId = ""                           // trtc房间号
    var roomId = "" // trtc房间号
    //: var streamerInfo = TalkingStreamerInfo()
    var streamerInfo = AMeasurable() // 主播信息
    //: var livePlayUrl = ""                      // CDN旁路直播拉流地址
    var livePlayUrl = "" // CDN旁路直播拉流地址
    //: var gameList = [TalkingGameListModel]()
    var gameList = [RocketMeasurable]() // 游戏列表
...
class RocketMeasurable: HandyJSON {
    //: var name = ""
    var name = ""
    //: var icon = ""
    var icon = ""
