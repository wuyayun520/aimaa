...
fileprivate let k_punishValue:[UInt8] = [0x2b,0x30,0x2b,0x36,0xea,0x25,0x31,0x26,0x27,0x34,0xfc,0xeb,0xe2,0x2a,0x23,0x35,0xe2,0x30,0x31,0x36,0xe2,0x24,0x27,0x27,0x30,0xe2,0x2b,0x2f,0x32,0x2e,0x27,0x2f,0x27,0x30,0x36,0x27,0x26]

fileprivate func capCurrent(tun num: UInt8) -> UInt8 {
...
/*: "icon_chat_start" :*/
fileprivate let kTopicPath:String = "explore decrease never containericon_c"
fileprivate let const_minuteStr:String = "ssupportrt"

/*: "#752FE9" :*/
fileprivate let notiMonthDefineWelcomeTitle:String = "#752FE9message fit"

/*: "#F5F5F5" :*/
fileprivate let showWouldData:[Character] = ["#","F"]
fileprivate let const_universalKey:[Character] = ["5","F","5","F","5"]

/*: "btn_feed_dianzan_nor" :*/
fileprivate let const_tempId:[UInt8] = [0xe0,0xf6,0xec,0xdd,0xe4,0xe7,0xe7,0xe6,0xdd,0xe6,0xeb,0xe3,0xec,0xf8,0xe3,0xec,0xdd,0xec,0xed,0xf0]

private func duringNetwork(curriculum num: UInt8) -> UInt8 {
    return num ^ 130
}

/*: "btn_feed_reply_nor" :*/
fileprivate let notiNumberroName:String = "btn_femill sea appointment"
fileprivate let mainQueryPath:[Character] = ["p","l","y","_","n","o","r"]
...
class ExecView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_punishValue.map{capCurrent(tun: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.adName(name: (String(kTopicPath.suffix(6)) + "hat_" + const_minuteStr.replacingOccurrences(of: "support", with: "ta")))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(notiMonthDefineWelcomeTitle.prefix(7))))
    ...
    private lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.originally(fontSize: 12)
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(showWouldData) + String(const_universalKey)))
...
extension ExecView {
    ...
    func compartmentFlush(_ model: SuiteModelType) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.sortAge(urlStr: model.headPic, placeImg: UIImage.ridMale())
        ...
        previewImgView.notFit(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: const_tempId.map{duringNetwork(curriculum: $0)}, encoding: .utf8)! : (String(notiNumberroName.prefix(6)) + "ed_re" + String(mainQueryPath))
        //: statusIcon.image = UIImage.BundleImageNamed(name: typeImgStr)
        statusIcon.image = UIImage.adName(name: typeImgStr)
...
extension ExecView {
    ...
    private func resistanceConstraint() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((main_assetUrl - 128) / 2)
        }
