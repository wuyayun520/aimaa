...
fileprivate let showElectricSecretContent:[UInt8] = [0xfc,0xfb,0xfc,0xe1,0xbd,0xf6,0xfa,0xf1,0xf0,0xe7,0xaf,0xbc,0xb5,0xfd,0xf4,0xe6,0xb5,0xfb,0xfa,0xe1,0xb5,0xf7,0xf0,0xf0,0xfb,0xb5,0xfc,0xf8,0xe5,0xf9,0xf0,0xf8,0xf0,0xfb,0xe1,0xf0,0xf1]

private func signScenario(nature num: UInt8) -> UInt8 {
    return num ^ 149
}

/*: "Cancel" :*/
fileprivate let main_globValue:String = "Cancellimited equally"

/*: "Sure" :*/
fileprivate let main_viewPartCommunicateName:String = "Sureoccur special"
...
class PeerPickView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showElectricSecretContent.map{signScenario(nature: $0)}, encoding: .utf8)!)
    }
    ...
    private func coverView() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(behindTickView))
        ...
        cancelButton.setTitle((String(main_globValue.prefix(6))).localized, for: .normal)
        //: cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: cancelButton.setTitleColor(UIColor.black, for: .normal)
        cancelButton.setTitleColor(UIColor.black, for: .normal)
        //: cancelButton.addTarget(self, action: #selector(cancelClick(button:)), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(buttonCount(button:)), for: .touchUpInside)
        ...
        confirmButton.setTitle((String(main_viewPartCommunicateName.prefix(4))).localized, for: .normal)
        //: confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: confirmButton.setTitleColor(UIColor.black, for: .normal)
        confirmButton.setTitleColor(UIColor.black, for: .normal)
        //: confirmButton.addTarget(self, action: #selector(confirmClick(button:)), for: .touchUpInside)
        confirmButton.addTarget(self, action: #selector(error(button:)), for: .touchUpInside)
    ...
    private func businessOrganization() {
    ...
    @objc func buttonCount(button _: UIButton) {
        //: dismissView()
        behindTickView()
    }

    //: @objc func confirmClick(button: UIButton) {
    @objc func error(button _: UIButton) {
        //: dismissView()
        behindTickView()
    }
