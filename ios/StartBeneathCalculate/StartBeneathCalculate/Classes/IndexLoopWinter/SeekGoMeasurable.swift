...
struct SeekGoMeasurable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: BroadHandyJSON?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [ViewGalleryModel]? // 相册
    ...
    var aiExtraInfo = StretchSpanMeasurable() // AI模型
    //: var vipSkinId = 0
...
struct ViewGalleryModel: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func pocketSized(compareTo: ViewGalleryModel) -> Bool {
        //: return
        return
...
struct StretchSpanMeasurable: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
