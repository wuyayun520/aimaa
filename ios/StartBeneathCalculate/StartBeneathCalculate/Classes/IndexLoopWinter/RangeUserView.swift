...
/*: "icon_randow_user_bg" :*/
fileprivate let noti_reachFormat:String = "effective quantityicon_r"
fileprivate let const_arenaTitle:String = "pull"
fileprivate let noti_oneFollowUrl:[Character] = ["n","d","o","w","_","u","s","e","r","_","b","g"]
...
class RangeUserView: UIView {
    // MARK: - UI Components

    //: private let leftAvatarView = AvatarView()
    private let leftAvatarView = GenerationView()
    //: private let centerAvatarView = AvatarView()
    private let centerAvatarView = GenerationView()
    //: private let rightAvatarView = AvatarView()
    private let rightAvatarView = GenerationView()
    ...
    private func setupLocation() {
        ...
        centerBgView.image = UIImage.adName(name: (String(noti_reachFormat.suffix(6)) + const_arenaTitle.replacingOccurrences(of: "pull", with: "a") + String(noti_oneFollowUrl)))
    }

    //: private func updateAvatarDisplay() {
    private func searchDisplay() {
    ...
    private func accommodateAvatar() {
...
extension RangeUserView {
    // MARK: - Public Methods

    //: func configure(avatars: [String]) {
    func underevaluation(avatars: [String]) {
...
class GenerationView: UIView {
    ...
    private func aCover() {
        ...
        imageView.notFit(urlStr: self.imageurl ?? "")
    }
}
