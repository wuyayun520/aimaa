...
enum PublicHouseMultiplierTarget: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum ConfirmRangeCustomReflectable: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
@objc enum PenConstantTarget: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum ReportedSubscriptType: Int {
    //: case Unavailable = 0
...
enum TillCaseIterable: CaseIterable {
...
enum UnderlyingHashableRepresentation: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2
