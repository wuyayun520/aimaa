...
class ReportedViewDelegate: SafetyFactorViewController {
    ...
    override func viewDidLoad() {
        ...
        ShSeparateThen.program().delegate = self
    ...
    private lazy var bottomView: GrossThen = {
        //: let view = TalkingLiveRoomBottomView(frame: .zero)
        let view = GrossThen(frame: .zero)
    ...
    private lazy var floatScreenView: OrbicularThen = { // 飘屏
...
extension ReportedViewDelegate {
    ...
    func first() {
        ...
        ShSeparateThen.direct(groupId: BeReactiveCompatible.clearExplain().liveRoomModel.chatGroupId, announcementMsg: BeReactiveCompatible.clearExplain().liveRoomModel.notification)
...
extension ReportedViewDelegate {
    ...
    func route(animated: Bool = true) {
        ...
        ShSeparateThen.program().delegate = nil
...
extension ReportedViewDelegate: SuiteThen {
...
extension ReportedViewDelegate {
    ...
    func dealMsg(Msg: FastenHandyJSON) {
...
extension ReportedViewDelegate: InsertrViewDelegate {
    ...
    func objectificationPriority(msgStr: String, toUid: String?) {
        ...
        ShSeparateThen.themeFeedback(groupId: BeReactiveCompatible.clearExplain().liveRoomModel.chatGroupId, message: msgStr, toUid: toUid) { succeed, _, _ in
            //: if succeed {
            if succeed {}
        }
    }
