...
extension Dictionary {
    ...
    public static func chevalGlass(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func beginShoo(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.chevalGlass(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
