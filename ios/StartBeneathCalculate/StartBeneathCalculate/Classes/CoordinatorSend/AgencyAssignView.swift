...
extension AgencyAssignView {
    ...
    @objc func clickVertical() {
        //: let vc = TalkingPrivateChatController(chatID: AnimateUnaryAllocator.getCustomerServiceID())
        let vc = BorderInsularViewDelegate(chatID: AnimateUnaryAllocator.receiveRemove())
