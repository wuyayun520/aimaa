...
extension UniversalViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .Notifications, .Social_Preferences:
            ...
            let cell: TagAgoThen = tableView.dequeueReusableCell(withIdentifier: TagAgoThen.className(), for: indexPath) as! TagAgoThen
...
extension UniversalViewController {
    ...
    private func proposalQuantity() {
        ...
        guard AlsoThen.shared.isGeneral == false else { // 音视频通话中
...
extension UniversalViewController {
    ...
    private func see() {
        ...
        MainTable.register(TagAgoThen.self, forCellReuseIdentifier: TagAgoThen.className())
