...
class SmartViewController: SafetyFactorViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if AlsoThen.shared.isGeneral == true { // 正在音视频通话，静音播放
    ...
    private lazy var backBtn: UIButton = {
        ...
        v.contentHorizontalAlignment = TaLanguageManager.shared.direction == .rightToLeft ? .right : .left
...
extension SmartViewController {
    ...
    @objc func subedit() {
        ...
        if slider == nil {
            ...
            slider = WhiteThen(frame: frame, url: self.videoURL!, imgWidth: imgWidth, maxDuration: maxduration, minVideoDuration: notiNameStr)
