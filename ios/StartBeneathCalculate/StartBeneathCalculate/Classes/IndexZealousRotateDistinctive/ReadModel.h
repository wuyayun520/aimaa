...
@property (nonatomic, strong)DisplaceModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)LifetimePointModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)ProfessionalModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)NihilModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)OccurModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)FirstSolidTitleTheoryModel *quoteMsgInfo;

//: @property (nonatomic, strong)ConsumerPenHandyJSON *userInfoModel;
@property (nonatomic, strong)ConsumerPenHandyJSON *userInfoModel;
...
@protocol VitaminPillModel
//: @end
@end
//: @interface QuestionQuickReplayModel: JSONModel
@interface VitaminPillModel: JSONModel
...
@interface DisplaceModel : JSONModel
...
@property (nonatomic, strong) CarryModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) OthersModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) HintModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) SourceModel *wantGift; /// 想要礼物
...
@property (nonatomic, strong) NSArray<VitaminPillModel> *replay; /// v1.9.8 男性用户需要回复的选择内容
...
@interface CarryModel : JSONModel
...
@interface OthersModel: JSONModel
...
@interface LifetimePointModel : JSONModel
...
@interface ProfessionalModel : JSONModel
...
@interface NihilModel : JSONModel
...
@interface OccurModel : JSONModel
...
@interface FirstSolidTitleTheoryModel : JSONModel
...
@property (nonatomic, strong) ComputerBusinessModel *renderData;
...
@interface ComputerBusinessModel : JSONModel
