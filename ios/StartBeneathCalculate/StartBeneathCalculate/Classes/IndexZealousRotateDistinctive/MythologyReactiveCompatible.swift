...
// __CLOSE_PRINT__
//
//  MythologyReactiveCompatible.swift
//  AbroadTalking
//
...
protocol ArrayMixtureLayoutDelegate: NSObjectProtocol {
...
class MythologyReactiveCompatible: UICollectionViewFlowLayout {
    //: var delegate: TalkingTagCollectionFlowLayoutDelegate?
    var delegate: ArrayMixtureLayoutDelegate?
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for i in 1..<attributes.count {
            ...
            if i == attributes.count-1 {
                ...
                self.delegate?.connect(layoutH: curAttr.frame.maxY)
            }
        }
