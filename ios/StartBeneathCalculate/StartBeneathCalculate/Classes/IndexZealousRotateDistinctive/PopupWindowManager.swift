...
extension PopupWindowManager {
    ...
    func actionCurveVariation(type: IncidentCaseIterable) {
        ...
        case .sign_in:
            ...
            //: SmartThen.share.func__pushToWebVC(webViewType: .SiginPopup)
            SmartThen.share.joinType(webViewType: .SiginPopup)
...
//            if MacroBorderDefineThen.getWindow().subviews.count >= 3 {
//                return
//            }
...
//            }
        ...
        case .transfer_Success:
            ...
            let view = ViewSuccessThen(frame: CGRect(x: 0, y: 0, width: main_assetUrl, height: kTopUrl))
            //: view.show()
            view.frankRefer()
