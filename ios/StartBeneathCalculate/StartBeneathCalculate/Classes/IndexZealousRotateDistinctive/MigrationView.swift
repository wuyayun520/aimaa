...
fileprivate let constResolutionBuildName:[UInt8] = [0xe9,0xee,0xe9,0xf4,0xa8,0xe3,0xef,0xe4,0xe5,0xf2,0xba,0xa9,0xa0,0xe8,0xe1,0xf3,0xa0,0xee,0xef,0xf4,0xa0,0xe2,0xe5,0xe5,0xee,0xa0,0xe9,0xed,0xf0,0xec,0xe5,0xed,0xe5,0xee,0xf4,0xe5,0xe4]

private func financialYear(beauty num: UInt8) -> UInt8 {
    return num ^ 128
}
...
class MigrationView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constResolutionBuildName.map{financialYear(beauty: $0)}, encoding: .utf8)!)
    }
...
extension MigrationView {
    ...
    private func insideInformation() {
