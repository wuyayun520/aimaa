...
@objcMembers public class TagReactiveCompatible: NSObject {
    ...
    class func track() -> TagReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = TagReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func frameLess() -> TagReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = TagReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func discountNet() -> TagReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = TagReactiveCompatible.init(isIncomming: false)
    ...
    class func talk() -> TagReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = TagReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func indexBlue() -> TagReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = TagReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
