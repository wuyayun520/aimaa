...
class SmartReactiveCompatible: SafetyFactorViewController {
    ...
    lazy var MainTable: UITableView = {
        ...
        table.register(MeasuringThen.self, forCellReuseIdentifier: MeasuringThen.className())
...
extension SmartReactiveCompatible: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let identifier = MeasuringThen.className()
        //: var cell = tableView.dequeueReusableCell(withIdentifier: identifier) as? TalkingWhoLikeCell
        var cell = tableView.dequeueReusableCell(withIdentifier: identifier) as? MeasuringThen
        //: if cell == nil {
        if cell == nil {
            //: cell = TalkingWhoLikeCell(style: .default, reuseIdentifier: identifier)
            cell = MeasuringThen(style: .default, reuseIdentifier: identifier)
        }
...
extension SmartReactiveCompatible: LikeThen {
