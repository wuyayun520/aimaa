...
class AsyncControllerHandler: NSObject {
    ...
    static let share = AsyncControllerHandler()
...
extension AsyncControllerHandler {
    ...
    static func tab() -> Bool {
        ...
        let arr = AsyncControllerHandler.share.blackListAreaArr
        //: for model in arr {
        for model in arr {
