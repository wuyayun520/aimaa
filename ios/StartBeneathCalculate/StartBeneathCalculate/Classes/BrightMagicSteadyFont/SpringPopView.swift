...
fileprivate let noti_womanValue:[UInt8] = [0x44,0x49,0x44,0x4f,0x3,0x3e,0x4a,0x3f,0x40,0x4d,0x15,0x4,0xfb,0x43,0x3c,0x4e,0xfb,0x49,0x4a,0x4f,0xfb,0x3d,0x40,0x40,0x49,0xfb,0x44,0x48,0x4b,0x47,0x40,0x48,0x40,0x49,0x4f,0x40,0x3f]

fileprivate func biologicalScale(cram num: UInt8) -> UInt8 {
...
fileprivate let dataOutputStr:[Character] = ["U","I","T","a","b","l","e","V","i","e","w","C","e","l","l","C","o","n","t","e","n"]
fileprivate let k_mirrorName:[Character] = ["t","V","i","e","w"]
...
class SpringPopView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(commit))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_womanValue.map{biologicalScale(cram: $0)}, encoding: .utf8)!)
    }
    ...
    func mps() {
        ...
        self.field()?.view.endEditing(true)
...
extension SpringPopView: UIGestureRecognizerDelegate {
    ...
    func gestureRecognizer(_: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        ...
        if classStr == (String(dataOutputStr) + String(k_mirrorName)) {
            //: return false
            return false
            //: }else {
        } else {
