...
class AutoCustomOperation: UITableViewCell {
    //: var currenModel = TalkingVideoCallRecordModel()
    var currenModel = LitePivotalNotification()
...
extension AutoCustomOperation {
    //: func setVideoCallCell(model: TalkingVideoCallRecordModel) {
    func colorRoute(model: LitePivotalNotification) {
        //: currenModel = model
        currenModel = model
