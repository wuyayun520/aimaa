...
fileprivate let appRocketMixAdoptValue:[UInt8] = [0x96,0x9b,0x96,0xa1,0x55,0x90,0x9c,0x91,0x92,0x9f,0x67,0x56,0x4d,0x95,0x8e,0xa0,0x4d,0x9b,0x9c,0xa1,0x4d,0x8f,0x92,0x92,0x9b,0x4d,0x96,0x9a,0x9d,0x99,0x92,0x9a,0x92,0x9b,0xa1,0x92,0x91]

fileprivate func greenBiological(frank num: UInt8) -> UInt8 {
...
class GrossViewCell: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appRocketMixAdoptValue.map{greenBiological(frank: $0)}, encoding: .utf8)!)
    }
    ...
    func blockFollow() {
        ...
        let doubletap = UITapGestureRecognizer(target: self, action: #selector(family))
...
extension GrossViewCell: UIScrollViewDelegate {
    //: @objc func imageViewClick(tap: UIGestureRecognizer) {
    @objc func backTap(tap _: UIGestureRecognizer) {
        //: if sblock != nil {
        if sblock != nil {
            //: sblock()
            sblock()
    ...
    @objc func family(tap: UIGestureRecognizer) {
