...
fileprivate let user_yourselfName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_me_edit" :*/
fileprivate let noti_courseFormat:String = "tap target addition gumbtn_"
fileprivate let const_windowFormat:[Character] = ["t"]
...
class IonReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_yourselfName.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.adName(name: (String(noti_courseFormat.suffix(4)) + "me_edi" + String(const_windowFormat))))
...
extension IonReactiveCompatible {
    //: func setCellMessage(titile: String, row: Int, isLast: Bool) {
    func setDoc(titile: String, row: Int, isLast: Bool) {
    ...
    func progressMedal(detail: String) {
    ...
    func arc() {
        ...
        titleBLB.font = UIFont.recipeDecision(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.recipeDecision(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
    ...
    func nonconformity(detail: String) {
        //: index = 0
        index = 0
        //: islast = true
        islast = true
