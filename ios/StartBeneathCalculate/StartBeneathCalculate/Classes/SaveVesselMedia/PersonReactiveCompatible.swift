...
fileprivate let noti_starPath:[UInt8] = [0x75,0x72,0x75,0x68,0x34,0x7f,0x73,0x78,0x79,0x6e,0x26,0x35,0x3c,0x74,0x7d,0x6f,0x3c,0x72,0x73,0x68,0x3c,0x7e,0x79,0x79,0x72,0x3c,0x75,0x71,0x6c,0x70,0x79,0x71,0x79,0x72,0x68,0x79,0x78]

private func finishTrade(radical num: UInt8) -> UInt8 {
    return num ^ 28
}

/*: "Any" :*/
fileprivate let showFigureId:[Character] = ["A","n","y"]
...
class PersonReactiveCompatible: PeerPickView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_starPath.map{finishTrade(radical: $0)}, encoding: .utf8)!)
    }
    ...
    override func error(button: UIButton) {
        ...
        if selectedValue.count <= 0 {
            ...
            selectedValue = dataArr.first ?? (String(showFigureId))
        }
...
extension PersonReactiveCompatible: UIPickerViewDelegate, UIPickerViewDataSource {
