    ...
    class func superCollection(superView: UIView?) {
        ...
        if superView != nil {
            ...
            DispatchQueue.main.async {
                ...
                //: ProgressHUD.shared.activityIndicator.center = ProgressHUD.shared.center
                StrangerProgressHUD.shared.activityIndicator.center = StrangerProgressHUD.shared.center
                //: MacroBorderDefineThen.getWindow().addSubview(ProgressHUD.shared)
                MacroBorderDefineThen.frameworkWindow().addSubview(StrangerProgressHUD.shared)
            }
        }
...
extension StrangerProgressHUD {
    ...
    class func frankFor(_ str: String?, showTime: CGFloat) {
        ...
        titleLab.textColor = .white
        //: MacroBorderDefineThen.getWindow().addSubview(titleLab)
        MacroBorderDefineThen.frameworkWindow().addSubview(titleLab)
        //: let size = titleLab.sizeThatFits(CGSize(width: UIScreen.main.bounds.width - 40, height: CGFloat(MAXFLOAT)))
        let size = titleLab.sizeThatFits(CGSize(width: UIScreen.main.bounds.width - 40, height: CGFloat(MAXFLOAT)))
        //: titleLab.center = MacroBorderDefineThen.getWindow().center
        titleLab.center = MacroBorderDefineThen.frameworkWindow().center
