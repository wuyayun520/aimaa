...
public extension PersonAlertShow {
                              ...
                              config: InstAlertConfig? = nil)
    {
        ...
        //: AnimateUnaryAllocator.getWindow().addSubview(alertView)
        AnimateUnaryAllocator.frameworkWindow().addSubview(alertView)
    ...
    class func quantityerrupt() {
        //: AnimateUnaryAllocator.getWindow().subviews.forEach { (view) in
        AnimateUnaryAllocator.frameworkWindow().subviews.forEach { view in
