...
open class InListviewReducer: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = InListviewReducer.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
