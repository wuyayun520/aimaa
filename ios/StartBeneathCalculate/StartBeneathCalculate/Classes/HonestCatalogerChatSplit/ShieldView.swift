...
fileprivate let showIndigenousId:[UInt8] = [0xbc,0xc1,0xbc,0xc7,0x7b,0xb6,0xc2,0xb7,0xb8,0xc5,0x8d,0x7c,0x73,0xbb,0xb4,0xc6,0x73,0xc1,0xc2,0xc7,0x73,0xb5,0xb8,0xb8,0xc1,0x73,0xbc,0xc0,0xc3,0xbf,0xb8,0xc0,0xb8,0xc1,0xc7,0xb8,0xb7]

fileprivate func securePro(port num: UInt8) -> UInt8 {
...
class ShieldView: UIView {
    ...
    class func overdo(_ frame: CGRect) -> UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showIndigenousId.map{securePro(port: $0)}, encoding: .utf8)!)
    }
