...
@objcMembers public class CommonalityCellData: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func rankWidth(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class PanelWillViewCell: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: CommonalityCellData?
    ...
    @objc dynamic public func lineStreetwise(with data: CommonalityCellData) {
        //: self.data = data
        self.data = data
    }
} 