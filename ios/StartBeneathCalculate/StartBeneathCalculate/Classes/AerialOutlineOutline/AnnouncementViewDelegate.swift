...
extension AnnouncementViewDelegate: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        //: case .My_Wallet:
        case .My_Wallet:
            //: SmartThen.share.func__pushToWebVC(webViewType: .RechargeFullPage)
            SmartThen.share.joinType(webViewType: .RechargeFullPage)
        ...
        //: case .My_NewApp:
        case .My_NewApp:
            //: SmartThen.share.func__pushToWebVC(webViewType: .NoForcedTransfer)
            SmartThen.share.joinType(webViewType: .NoForcedTransfer)
