...
extension TraceProfilesVc: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            ...
            let identifier = DeserializeFirstStoryboard.className()
            //: var cell = tableView.dequeueReusableCell(withIdentifier: identifier) as? TalkingEditAboutMeCell
            var cell = tableView.dequeueReusableCell(withIdentifier: identifier) as? DeserializeFirstStoryboard
            //: if cell == nil {
            if cell == nil {
                //: cell = TalkingEditAboutMeCell(style: .default, reuseIdentifier: identifier)
                cell = DeserializeFirstStoryboard(style: .default, reuseIdentifier: identifier)
            }
...
// MARK: - SeekEndBuilderLifecycle

//: extension TalkingEditProfilesVC: EditTagDelegate {
extension TraceProfilesVc: SeekEndBuilderLifecycle {
    //: func freshSeleteTag() {
    func putToWork() {
        //: seleteAboutme =  FacultyReactiveCompatible.share.loginUserMode.aboutMe!
        seleteAboutme = FacultyReactiveCompatible.share.loginUserMode.aboutMe!
...
extension TraceProfilesVc {
    ...
    private func primary() {
        ...
        MainTable.register(DeserializeFirstStoryboard.self, forCellReuseIdentifier: DeserializeFirstStoryboard.className())
