...
class ActivatedViewImplement: NSObject {
...
extension ActivatedViewImplement {
    /// 释放资源
    ...
    func equal(_ frontCamera: Bool) {
        ...
        self.enableErrorFace(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func become(_ openCamera: Bool) {
        ...
        self.controlDoing(isOpen: openCamera)
    }
    
    /// 更改视频采集渲染展示位置
    //: func changeRenderView() {
    func contentChangeLab() {
        ...
        DispatchQueue.main.async {
            ...
            self.tingSun(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension ActivatedViewImplement {
    ...
    private func enableErrorFace(front: Bool) {
    ...
    private func controlDoing(isOpen: Bool) {
        //: if isOpen {
        if isOpen {
...
extension ActivatedViewImplement {
    ...
    func stepCustom() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(awakeNotif(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(betweenHostNotif(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(courseNotif(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(funIssue(notif:)),
    ...
    @objc private func awakeNotif(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func betweenHostNotif(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func courseNotif(notif: Notification) {
    ...
    @objc func funIssue(notif: Notification) {
