...
class TrueDataSource: UIView {
    ...
    private lazy var liveView: ViewReactiveCompatible = {
        ...
        v.tapGestureBlock = { [weak self] in
            ...
            guard let self = self else { return }
            //: SmartThen.share.func_audiencePushToLiveRoomVC(uid: self.userInfoModel.uid, enterType: .userDetail)
            SmartThen.share.simpleAlong(uid: self.userInfoModel.uid, enterType: .userDetail)
        }
        //: return v
        return v
        //: }()
...
extension TrueDataSource {
    ...
    private func gestureEye() {
        ...
        let vc = AssignThen(videoPath: self.userInfoModel.videoUrl)
    ...
    @objc func destinationClick() {
        ...
        let url = GuideThen.hire(urlType: .Intimate) + (String(dataPartnerId)) + "\(self.userInfoModel.uid)"
