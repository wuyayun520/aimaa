...
class HandleTensorZone: SafetyFactorViewController {
...
extension HandleTensorZone {
    ...
    @objc func connectDefine() {
        ...
        let view = AsyncArithmeticPicker(frame: CGRect(x: 0, y: 0, width: main_assetUrl, height: kTopUrl))
        //: view.show()
        view.owner()
