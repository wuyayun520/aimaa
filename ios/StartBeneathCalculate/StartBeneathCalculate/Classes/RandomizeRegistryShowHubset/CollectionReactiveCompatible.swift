...
fileprivate let data_screenId:[UInt8] = [0x9f,0x98,0x9f,0x82,0xde,0x95,0x99,0x92,0x93,0x84,0xcc,0xdf,0xd6,0x9e,0x97,0x85,0xd6,0x98,0x99,0x82,0xd6,0x94,0x93,0x93,0x98,0xd6,0x9f,0x9b,0x86,0x9a,0x93,0x9b,0x93,0x98,0x82,0x93,0x92]

private func galleryPull(res num: UInt8) -> UInt8 {
    return num ^ 246
}
...
class CollectionReactiveCompatible: EarthThen {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_screenId.map{galleryPull(res: $0)}, encoding: .utf8)!)
    }
