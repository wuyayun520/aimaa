...
public protocol LikeThen: NSObject {
...
class MeasuringThen: UITableViewCell {
...
extension MeasuringThen {
    ...
    @objc func noneArc() {
        ...
        if currenModel.status == 0 {
            //: SmartThen.share.func__pushToPriveteChatVC(chatID: currenModel.uid)
            SmartThen.share.aboveCompletion(chatID: currenModel.uid)
