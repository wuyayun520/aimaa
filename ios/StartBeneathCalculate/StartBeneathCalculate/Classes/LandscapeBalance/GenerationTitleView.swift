...
fileprivate let main_procedureMessage:[UInt8] = [0x81,0x86,0x81,0x9c,0xc0,0x8b,0x87,0x8c,0x8d,0x9a,0xd2,0xc1,0xc8,0x80,0x89,0x9b,0xc8,0x86,0x87,0x9c,0xc8,0x8a,0x8d,0x8d,0x86,0xc8,0x81,0x85,0x98,0x84,0x8d,0x85,0x8d,0x86,0x9c,0x8d,0x8c]

private func imageHire(compute num: UInt8) -> UInt8 {
    return num ^ 232
}
...
class GenerationTitleView: UITextView {
    /// 占位文字
    //: var placeholder: String?
    var placeholder: String?
    /// 占位文字颜色
    //: var placeholderColor: UIColor? = UIColor.appValueDetailColor()
    var placeholderColor: UIColor? = UIColor.keepRid()
...
//    var PlaceholderInsets: UIEdgeInsets = UIEdgeInsets(top: 5, left: 5, bottom: 5, right: 5)
    ...
    override init(frame: CGRect, textContainer: NSTextContainer?) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(plus(_:)), name: UITextView.textDidChangeNotification, object: nil)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_procedureMessage.map{imageHire(compute: $0)}, encoding: .utf8)!)
    }
