...
extension WantThen {
    ...
    func flashContrast(type: Int) {
        ...
        TagThen.intervalry(params: dict) { succeed, _, errorModel in
    ...
    //: func greetBtnClick() {
    func moreCover() {
        //: SmartThen.share.func__pushToPriveteChatVC(chatID: cunrrenModel.uid ?? "")
        SmartThen.share.aboveCompletion(chatID: cunrrenModel.uid ?? "")
    }
