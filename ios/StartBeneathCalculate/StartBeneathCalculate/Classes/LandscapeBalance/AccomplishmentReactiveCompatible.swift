...
fileprivate let showAnalysisValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
// __CLOSE_PRINT__
//
//  AccomplishmentReactiveCompatible.swift
//  AbroadTalking
//
...
class AccomplishmentReactiveCompatible: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.commercialMessage() {
    var roundBgColor = UIColor.commercialMessage() {
        //: willSet {
        willSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showAnalysisValue.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.recipeDecision(type: .Semibold, fontSize: 19)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.fillColor = UIColor.clear.cgColor
        //: layer.strokeColor = UIColor.commercialMessage().cgColor
        layer.strokeColor = UIColor.commercialMessage().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = kOutputStr
...
extension AccomplishmentReactiveCompatible {
    /// 创建UI
    ...
    func forwarding(totalTime: Int, currTime: Int) {
