...
struct ReportedMeasurable: HandyJSON {
    //: var gid: String!
    var gid: String! // 礼物Id
    //: var price: Int = 0
...
struct EaseModelType: HandyJSON {
    //: var num: Int?
    var num: Int? /// 数量
    //: var tag: String?
    var tag: String? /// 说明
...
struct MigrationTransformable: HandyJSON {
