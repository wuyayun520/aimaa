...
// __CLOSE_PRINT__
//
//  FunctionalInterfaceArray.swift
//  AbroadTalking
//
...
class FunctionalInterfaceArray: UIView {
    ...
    override func willMove(toSuperview _: UIView?) {
        ...
        ConfigureAxisService.shared.containerView?.isHidden = false
    }
    ...
    func towardPhone() {
        ...
        UIView.animate(withDuration: 0.3, delay: 2, options: .curveEaseOut) {
            ...
            ConfigureAxisService.shared.containerView?.isHidden = true
        }
    }
}
...
extension FunctionalInterfaceArray {
    /// 添加点击手势
    //: @discardableResult
    @discardableResult
    ...
    @objc func applyBecome(sender: UIPanGestureRecognizer) {
        ...
        if sender.state == .ended {
            ...
            ConfigureAxisService.shared.videoMiniPosition = CGPoint(x: recordX, y: recordY)
        }
    }
