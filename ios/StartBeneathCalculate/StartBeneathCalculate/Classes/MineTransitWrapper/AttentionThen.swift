...
protocol RetainReactiveCompatible: NSObject {
    ...
    func westFlagStatus(player: AttentionThen, status: StrangerPlayerStatus)

    //: func func__playerDuration(player: TalkingVideoPlayerManager, duration: Int, currentTime: Int)
    func secondTime(player: AttentionThen, duration: Int, currentTime: Int)

    //: func func__playerProgress(player: TalkingVideoPlayerManager, progress: CGFloat)
    func valid(player: AttentionThen, progress: CGFloat)
}

//: class TalkingVideoPlayerManager: NSObject {
class AttentionThen: NSObject {
    //: var isPlaying = false
    var isPlaying = false
    //: var isMute = false
    var isMute = false
    ...
    static let shared = AttentionThen()
...
extension AttentionThen {
    ...
    func setMuteEmpower(bEnable: Bool) {
        ...
        if AlsoThen.shared.isGeneral == true { // 音视频通话时静音
            //: isMute = true
            isMute = true
        }
...
extension AttentionThen: TXVodPlayListener {
