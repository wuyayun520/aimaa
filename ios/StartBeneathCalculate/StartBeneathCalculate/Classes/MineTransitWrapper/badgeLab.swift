...
class AvailableReactiveCompatible: UILabel {
    ...
    //: private func setup() {
    private func bassSetup() {
        //: translatesAutoresizingMaskIntoConstraints = false
        translatesAutoresizingMaskIntoConstraints = false
        //: layer.backgroundColor = UIColor.msgTipsColor().cgColor
        layer.backgroundColor = UIColor.supernumerary().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.recipeDecision(type: .Medium, fontSize: 11)
