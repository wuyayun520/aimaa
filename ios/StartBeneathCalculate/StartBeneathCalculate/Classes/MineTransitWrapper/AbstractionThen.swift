...
fileprivate let data_tradeStr:[UInt8] = [0x5e,0x63,0x5e,0x69,0x1d,0x58,0x64,0x59,0x5a,0x67,0x2f,0x1e,0x15,0x5d,0x56,0x68,0x15,0x63,0x64,0x69,0x15,0x57,0x5a,0x5a,0x63,0x15,0x5e,0x62,0x65,0x61,0x5a,0x62,0x5a,0x63,0x69,0x5a,0x59]

fileprivate func doingeTire(measurement num: UInt8) -> UInt8 {
...
typealias DeleteTagBlock = (BeUserTagModel) -> Void

//: class TalkingTagView: UIView {
class AbstractionThen: UIView {
    //: var deleteBlock: DeleteTagBlock!
    var deleteBlock: DeleteTagBlock!
    //: var titles = [UserSeleteTagModel]()
    var titles = [BeUserTagModel]()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_tradeStr.map{doingeTire(measurement: $0)}, encoding: .utf8)!)
    }
...
extension AbstractionThen: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension AbstractionThen: ExecThen {
...
extension AbstractionThen {
    //: func setframe(frame: CGRect) {
    func publishFrame(frame _: CGRect) {
