...
Pod::Spec.new do |s|
  s.name         = "StartBeneathCalculate"
  s.version      = "1.0.0"
  s.summary      = "iOS StartBeneathCalculate Module."
  s.author       = { "StartBeneathCalculate" => "StartBeneathCalculate.me" }
  s.homepage     = "StartBeneathCalculate"
  s.source       = { :git => "http://StartBeneathCalculate.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'StartBeneathCalculate/Classes/**/*'
  s.resources = "StartBeneathCalculate/Resources/*.bundle"
#  s.vendored_libraries = 'StartBeneathCalculate/Classes/**/*.a'
